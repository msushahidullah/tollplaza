...
<div class="offcanvas-menu">
    <div class="row">
        <div class="col-lg-8">
            <h4 class="ai-title"><img src="{{ url('assets/images/svg-icon/ai.png') }}" class="img-fluid">Ai Tool</h4>
        </div>
        <div class="col-lg-4">
    ...
    <div id="error-message"></div>
        ...
        <div class="tab-pane fade" id="pills-image" role="tabpanel" aria-labelledby="pills-image-tab">
            <form id="openai_generator_form2" onsubmit="return generatorFormImage();">
                ...
                <div class="ai-generate-btn">
                    <button id="image-generator" type="submit" class="btn btn-primary generate-btn-text text-white">Generate</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
