...
<body class="vertical-layout">
   <div class="row">
	   <div class="col-md-2 offset-md-10">
		<a href="{{ route('show.order',$order->order_id) }}" class="d-print-none btn btn-primary-rgba mt-2 ml-5"><i class="feather icon-arrow-left mr-2"></i>{{ __("Back")}}</a>   
	   </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-5 col-lg-5">
                                                <div class="invoice-name">
                                                    ...
                                                    <p class="mb-1">{{__("Total Qty:")}} {{ $order->qty_total }}</p>
                                                    ...
                                                    <h4 class="text-success mb-0 mt-3"> <i class="{{ $order->paid_in }}"></i>{{ round($order->order_total,2) }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                                ...
                                                <div class="order-total table-responsive ">
                                                    <table class="table table-borderless text-right">
                                                        <tbody>
                                                            <tr>
                                                                <td>{{__("Subtotal:")}} </td>
                                                                <td><i class="{{ $invoice->order->paid_in }}"></i>{{ round($order->order_total+$order->discount - $order->gift_charge,2) }}</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>+ <i class="{{ $invoice->order->paid_in }}"></i>{{ round($order->gift_charge,2) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>
																	{{__('Handling Charge:')}}
																</td>
                                                                <td>+ <i class="{{ $invoice->order->paid_in }}"></i>{{ round($order->handlingcharge,2) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="f-w-7 font-18"><h5>Grand Total:</h5></td>
                                                                <td class="f-w-7 font-18"><h5><i class="{{ $invoice->order->paid_in }}"></i>

																	{{ round($order->order_total+$order->handlingcharge,2) }}</h5></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
