        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a title="Print Slip" onclick="window.print()" class="d-print-none float-right btn btn-md btn-primary-rgba">
                        <i class="fa fa-print"></i>
                    </a>
                    <a title="Back" href="{{ route('return.order.index') }}" class="d-print-none mr-2 float-right btn btn-md btn-primary-rgba">
