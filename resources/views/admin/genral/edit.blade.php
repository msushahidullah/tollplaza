          ...
          <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/genral/')}}"
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    <label for="min_pur_amount">{{__('Minimum Purchase Amount')}}:</label>
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input step="0.1" placeholder="0.00" type="number" value="{{ $row->min_pur_amount }}"
                  ...
                  <div class="col-md-6">
                    <label for="mim_seller_wid_amount">{{__('Mininmum Seller Withdrowl Amount')}}: </label>
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input step="0.1" placeholder="0.00" type="number" value="{{ $row->mim_seller_wid_amount }}"
