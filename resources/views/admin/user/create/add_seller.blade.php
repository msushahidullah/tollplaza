...
@section('title',__("Create a new seller"))
@section('body')

<?php
  $data['heading'] = 'Create a new seller';
  $data['title0'] = 'Sellers';
  $data['title1'] = 'Create a new seller';
?>
        ...
        @endif
          ...
          <div class="card m-b-30">
              <div class="card-header">
                ...
                <div class="row">
                  <div class="col-lg-10">
                      <h5 class="card-title"> <h5 class="card-title"> {{__("Create a new seller")}}</h5></h5>
                  </div>
                  <div class="col-md-2">
                    <div class="widgetbar">
