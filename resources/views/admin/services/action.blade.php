<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
      ...
      @if(!in_array($id,['1','2','3','4','5']))
        <a class="dropdown-item"   href="{{ route('services.edit',$id) }}"><i class="feather icon-edit mr-2"></i>{{ __("Edit")}}</a>
      @else 
    ...
    @endif
        ...
        <a class="dropdown-item"  data-toggle="modal" data-target="#delete{{ $id }}" @else
    ...
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form method="post" action="{{ route('services.destroy',$id) }}" class="pull-right">
            {{csrf_field()}}
            {{method_field("DELETE")}}
