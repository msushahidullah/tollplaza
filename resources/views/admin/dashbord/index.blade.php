                ...
                <div class="col-lg-12 col-xl-12">
                    ...
                    <div class="alert alert-success alert-dismissible fade show">
                        ...
                        <form action="{{ url('/merge-quick-update') }}" method="POST"
                            class="float-right display-none updaterform">
                            @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ route('users.index') }}"> <i
                                                    class="text-success feather icon-user iconsize"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ url('admin/order') }}"> <i
                                                    class="text-warning feather icon-shopping-cart mr-2 iconsize"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ url('admin/ord/canceled') }}"> <i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ url('admin/products') }}"> <i
                                                    class="text-primary feather icon-truck iconsize"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ url('admin/stores') }}"> <i
                                                    class="text-info feather icon-home iconsize"></i>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ url('admin/category') }}"> <i
                                                    class="text-secondary feather icon-shopping-bag iconsize"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ url('admin/coupan') }}"> <i
                                                    class="text-success feather icon-grid iconsize"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ url('admin/faq') }}"> <i
                                                    class="text-warning feather icon-help-circle iconsize"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="card m-b-30 shadow-sm">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                                <a href="{{ route('seller.payouts.index') }}"> <i
                                                        class="text-danger feather icon-credit-card iconsize"></i>
                                                </a>
                                            </div>
                                ...
                                <div class="card m-b-30 shadow-sm">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                                <a href="{{ route('users.index', ['filter' => 'sellers']) }}"> <i
                                                        class="text-warning feather icon-users iconsize"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ route('testimonial.index') }}"> <i
                                                    class="text-primary feather  icon-sliders iconsize"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ route('special.index') }}"> <i
                                                    class="text-info feather icon-gift iconsize"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="card m-b-30 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 animate__animated animate__fadeIn animate__delay-2s">
                                            <a href="{{ route('hotdeal.index') }}"> <i
                                                    class="text-secondary feather icon-archive iconsize"></i>
                                            </a>
                                        </div>
                                                ...
                                                <div class="col-9">
                                                            ...
                                                            @php
                                                                ...
                                                                if ($result) {
                                                                    ...
                                                                    if (isset($result->fan_count)) {
                                                                        echo '<h4 class="animate__animated animate__fadeIn animate__delay-1s">' .
                                                                            $result->fan_count .
                                                                            '</h4>';
                                                                    }
                                                                } else {
                                                    ...
                                                    @else
                                                        <p class="animate__animated animate__fadeIn animate__delay-1s">
                                                            <b>{{ __('Set up your facebook page key in Admin Dashboard Setting !') }}</b>
                                                        </p>
                                                    @endif
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    @else
                                                        <p class="animate__animated animate__fadeIn animate__delay-1s"><b>
                                                                ...
                                                                <br>{{ __('Admin Dashboard Setting !') }}</b></p>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <tbody>
                                                    @forelse($latestorders as $key=> $order)
                                                        <tr>
                                                            ...
                                                            <td><i
                                                                    class="{{ $order->paid_in }}"></i>{{ $order->order_total }}
                                                            </td>
                                        ...
                                        @foreach ($products->take($dashsetting->max_item_ord) as $pro)
                                            <div class="row mb-2">
                                                <div class="text-center col-md-2">
                                                    @if ($pro['thumbnail'] != '')
                                                        <img class="object-fit" height="50px" src="{{ $pro['thumbnail'] }}"
                                                            title="{{ $pro['productname'] }}"
                                                            alt="{{ __('Product image') }}">
                                                    @endif
                                                </div>
                                                <div class="col-md-8">
                                                    <a href="{{ $pro['producturl'] }}" class="product-title">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-7">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <span
                                                            class="{{ selected_lang()->rtl_available == 0 ? 'float-right' : 'float-left' }} mt-2 badge badge-success">{{ $registerTodayUsers }}
                                                            {{ __('members today') }}</span>
                                                    </div>
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item font-13"
                                                                    href="{{ route('users.index', ['filter' => 'customer']) }}">{{ __('View all users') }}</a>
                                                ...
                                                <div class="card-body text-center">
                                                    <span>
                                                        @if ($user->image != '' && file_exists(public_path() . '/images/user/' . $user->image))
                                                            <img class="mx-auto d-block user_image"
                                                                src="{{ url('images/user/' . $user->image) }}" alt="">
                                                        @else
                                                            <img class="mx-auto d-block user_image"
                                                    ...
                                                    <p>{{ $user->email }}</p>
                                                    <p><span
                                                            class="badge badge-primary-inverse">{{ date('Y-m-d', strtotime($user->created_at)) }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        @endforeach
