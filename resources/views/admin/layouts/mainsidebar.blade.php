@if($dashsetting->sidebar_enable== 1)
        ...
        <div class="input-group search-input">
          ...
          <div>
            ...
            <ul class="vertical-menu">
              ...
              <li class="header">{{ __('Stores & Products') }}</li>
              ...
              @canany(['shipping.manage','taxsystem.manage'])
                ...
                {{ Nav::isResource('tax') }}">
                  ...
                  <ul class="vertical-submenu">
                    ...
                    <li class="{{ Nav::isResource('handling.charge') }}"><a href="{{route('admin.handling.charge.index')}}">{{ __('Handling charges') }}</a></li>
                    <li class="{{ Nav::isResource('admin/shiping_charg') }}"><a href="{{url('admin/shiping_charg/index')}}">{{ __('Shipping charges') }}</a></li>
                    <li class="{{ Nav::isResource('admin/shi_cupan') }}"><a href="{{url('admin/shi_cupan')}}">{{ __('Shipping coupan') }}</a></li>
                  </ul>
                  @endcan
                </li>
              @endcan
              ...
              @canany(['hotdeals.view','blockadvertisments.view','advertisements.view','testimonials.view','offerpopup.setting','pushnotification.settings'])
                <li class="{{ Nav::isResource('flash-sales') }} {{ Nav::isRoute('admin.push.noti.settings') }} {{ Nav::isRoute('offer.get.settings') }} {{ Nav::isResource('testimonial') }} {{ Nav::isResource('adv') }} {{ Nav::isResource('hotdeal') }} {{ Nav::isResource('detailadvertise') }}">
                  ...
                  <ul class="vertical-submenu">
                    ...
                    <li><a class="{{ Nav::isResource('mobile/hotdeal') }}" href="{{url('mobile/hotdeal')}}">{{ __('Mobile Hot Deals') }}</a></li>
                    @endcan
...
<li class="{{ Nav::isRoute('admincustomisation') }}">
    <a href="{{url('admincustomisation')}}"><i
    ...
    <ul class="vertical-submenu">
      ...
      <li id="slider" class="treeview {{ Nav::isRoute('front.slider') }} {{ Nav::isResource('slider') }}">
        ...
        <ul class="vertical-submenu">
          ...
          <!-- <li class="{{ Nav::isResource('slider') }}"><a href="{{url('admin/slider2')}} ">{{ __('Sliders 2') }}</a></li>
			      <li class="{{ Nav::isResource('slider3') }}"><a href="{{url('admin/slider3')}} ">Sliders 3</a></li> -->
...
@canany(['pages.view'])
  <li
    class="{{ Nav::isResource('page') }} ">
    <a href="javaScript:void();">
      <i class="feather icon-settings" aria-hidden="true"></i> <span>{{ __("OpenAi") }}</span><span class="badge badge-danger">New</span>
      <i class="feather icon-chevron-right"></i>
    </a>
    ...
    <ul class="vertical-submenu">
      ...
      <li class=""><a title="{{ __('Progressive Web App Setting') }}"
          href="{{route('services.index')}} "><span>{{ __('Services') }}</span></a>
      </li>
      

      @can('color-options.manage')
      <li id="theme-settings" class="{{ Nav::isRoute('admin.theme.index') }}">
        <a href="{{url('user/openai')}}"><span>{{ __('User') }}</span>
        </a>
      </li>
      @endcan
...
@canany(['terms-settings.update','others.abuse-word-manage','site-settings.bank-settings','site-settings.dashboard-settings','site-settings.dashboard-settings1','site-settings.footer-customize','site-settings.genral-settings','site-settings.genral-settings','site-settings.language','site-settings.mail-settings','site-settings.maintenance-mode','site-settings.sms-settings','site-settings.social-handle','site-settings.social-login-settings','site-settings.style-settings'])
  ...
  <li id="sitesetting" class="{{ Nav::isResource('admin/seo-directory') }} {{ Nav::isRoute('get.user.terms') }} {{ Nav::isRoute('sms.settings') }}
    ...
    <ul class="vertical-submenu">
      ...
      @can('site-settings.seller-settings')
      <li class="{{ Nav::isRoute('admin.seller') }}">
        <a href="{{ route('admin.seller') }}"><span>{{ __('Best Seller') }}</span></a>
      </li>
      @endcan

      <li class="{{ Nav::isRoute('admin.banner') }}">
        <a href="{{ route('admin.banner') }}"><span>{{ __('Banner Settings') }}</span></a>
      </li>
