@if($dashsetting->seller_enable == 1)
                     ...
                     <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel"
                         ...
                         <ul class="vertical-menu">
                             ...
                             <li class="{{ Nav::isRoute('seller.dboard') }}">
                                 <a class="" href="{{route('seller.dboard')}}">
                             ...
                             <li class="{{ Nav::isRoute('get.profile') }}">
                                 <a class="" href="{{route('get.profile')}}">
                             ...
                             <li class="{{ Nav::isResource('store') }}">
                                 <a class="" href="{{route('store.index')}} ">
                                     <i class="feather icon-shopping-cart"></i>
                                     <span>{{__("Your Store") }}</span>
                                 </a>
                             </li>

                             <li  class="{{ Nav::isRoute('seller.gift') }} {{ Nav::isRoute('seller.gift.create') }} {{ Nav::isRoute('seller.gift.edit') }}">
                                 <a class="" href="{{ route('seller.gift.index') }} ">
