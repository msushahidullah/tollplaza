...
@section('title',__('Create Slider2'))
@section('body')
...
<div class="col-md-6">
  <div class="widgetbar">
  <a href="{{url('admin/slider2')}} " class=" btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i> {{ __("Back") }}</a>
  </div>
</div>
@endslot
​
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Create a new slider2') }}</h5>
        </div>
        <div class="card-body">
        <!-- main content start -->
          ...
          @csrf
           <div class="row">
             ...
             <div class="col-md-6">
               ...
               <br><br>
               <img src="{{ url('images/slider2preview.png') }}" class="img-fluid" alt="Responsive image" id="slider_preview" title="Image Preview" align="center">
