  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
          ...
          <input type="text" id="default-date" name="selling_start_at" value="{{ date('d-m-Y', strtotime($products->selling_start_at)) }}" class="form-control timepickerwithdate" placeholder="dd/mm/yyyy" aria-describedby="basic-addon2"/>
