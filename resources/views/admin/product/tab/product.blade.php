  ...
  <div class="row">
    ...
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <input pattern="[0-9]+(\.[0-9][0-9]?)?" onchange="commissionvalue()" title="{{ __("Price Format must be in this format : 200 or 200.25") }}" required=""
        type="text" id="price"  name="price" value="{{ old('price') }}" class="form-control">
      </div>
    ...
    <!-- <div class="col-md-2">
    <div class="form-group">
      <label class="text-dark">{{ __('Original Price :') }} <span class="text-danger">*</span>
      </label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">{{ $defCurrency->currency->code }}</span>
        ...
        type="text" id="original_price" onchange="commissionvalue()" name="original_price" value="{{ old('original_price') }}" class="form-control">
      </div>
      <small class="text-muted"><i class="fa fa-question-circle"></i> {{ __('Do not put comma whilt entering PRICE') }}</small>
      </div>
    </div>
    ...
    <div class="col-md-2">
    <div class="form-group">
      <label class="text-dark">{{ __('Commission :') }}
      </label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">{{ $defCurrency->currency->code }}</span>
        </div>
        <input title="{{ __("Offer price Format must be in this format : 200 or 200.25") }}" disabled pattern="[0-9]+(\.[0-9][0-9]?)?"
