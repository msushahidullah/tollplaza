...
<div class="col-md-6">
  <div class="widgetbar">
  @can('pages.create')
  <a href=" {{url('admin/return-policy/create')}}" class=" btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>{{ __('Add Return Policy') }}</a>
  @endcan
  </div>
</div>
@endslot
