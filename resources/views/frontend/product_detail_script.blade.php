       ...
       if(selling_date <= current_date){
         ...
         if(stock > 0 && stock <= 5)
          ...
          console.log(stock)
              ...
              $('.quantity-container').html('<div><div class="qty-count"><form action="" method="post">{{ csrf_field() }}<div><div class="cart-quantity"><div class="quant-input"></div></div><div class="add-btn"><button type="submit" class="btn btn-primary">{{ __('Add to Cart') }}</button></div></div></form></div>');
