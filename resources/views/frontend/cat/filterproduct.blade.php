                    ...
                    <div class="image {{ $sub->stock == 0 ? "pro_img-box" : "" }}">
                        ...
                        <a href="{{ $product->getURL($sub) }}" title="{{$product->name}}">
                            ...
                            $current_date <= $sub->products->selling_start_at
                                ...
                                <h6 align="center" class="oottext2"><span>{{ __('Coming Soon') }}</span></h6>
                                @endif
                    ...
                    <div class="action">
                        <ul class="list-unstyled">
                            ...
                            @if(Auth::user()->wishlist()->count() < 1) <li class="lnk wishlist">
                                ...
                                <a mainid="{{ $sub->id }}" title="{{ __('Add To WishList') }}"
                                    class="add-to-cart addtowish cursor-pointer"
                                    data-add="{{url('AddToWishList/'.$sub->id)}}"
                                    title="{{ __('Add To WishList') }}"> <i data-feather="heart"></i>
                                </a>
                                ...
                                <li class="lnk wishlist active">
                                    <a mainid="{{ $sub->id }}" title="{{ __('Remove From Wishlist') }}"
                                        class="add-to-cart removeFrmWish active cursor-pointer color000 add-wishlist"
                                        data-remove="{{url('removeWishList/'.$sub->id)}}"> 
                                        <i data-feather="heart"></i>
                                    </a>
                                </li>
                                @else
                                <li class="lnk wishlist"><a title="{{ __('Add To WishList') }}"
                                ...
                                <li class="lnk"> <a class="add-to-cart"
                                        ...
                                        {{ __('Compare') }}> <i data-feather="anchor"></i>
                                    </a> </li>
                        </ul>
                    </div>
                    <!-- /.action -->
                        ...
                        <ul class="list-unstyled">
                            ...
                            @if(Auth::user()->wishlist()->count() < 1) 
                                ...
                                <li class="lnk wishlist active">
                                    <a mainid="{{ $sub->id }}" title="{{ __('Remove From Wishlist') }}"
                                        class="add-to-cart removeFrmWish active cursor-pointer color000 add-wishlist"
                                        data-remove="{{url('removeWishList/'.$sub->id)}}"> <i data-feather="heart"></i>
                                    </a>
                                </li>
                                @else
                                <li class="lnk wishlist"><a title="{{ __('Add To WishList') }}"
