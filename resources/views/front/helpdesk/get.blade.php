            ...
            <form novalidate class="form" action="{{ route('hdesk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row padding15">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">{{ __('staticwords.Issue') }}: <span
                                            class="required">*</span></label>
                                    <input required type="text" name="issue_title"
                                        class="@error('issue_title') is-invalid @enderror form-control">
                                    @error('issue_title')
                        ...
                        <div class="form-group">
                            <label for="">{{ __('staticwords.DescribeyourIssue') }}: <span
                                    class="required">*</span></label>
                            <textarea required name="issue" id="editor1" cols="30" rows="10"
                                class="@error('issue') is-invalid @enderror form-control"></textarea>
                            @error('title')
                                <span class="invalid-feedback text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
