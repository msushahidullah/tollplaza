...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ url('front/home/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ url('front/home/css/owl.transitions.css') }}">
    <link rel="stylesheet" href="{{ url('front/home/css/main.css') }}"> --}}
...
<body class="cnt-home">
                ...
                <ul>
                    <li>
                        <div class="feature-box">
                            @if (isset($footer3_widget->icon_section1))
                                <i class="footericon fa {{ $footer3_widget->icon_section1 }}"></i>
                            @endif
                            <p></p>
                    ...
                    <li>
                        <div class="feature-box">
                            @if (isset($footer3_widget->icon_section2))
                                <i class="footericon fa {{ $footer3_widget->icon_section2 }}"></i>
                            @endif
                            <p></p>
                    ...
                    <li>
                        <div class="feature-box">
                            @if (isset($footer3_widget->icon_section3))
                                <i class="footericon fa {{ $footer3_widget->icon_section3 }}"></i>
                            @endif
                            <p></p>
                    ...
                    <li>
                        <div class="feature-box">
                            @if (isset($footer3_widget->icon_section4))
                                <i class="footericon fa {{ $footer3_widget->icon_section4 }}"></i>
                            @endif
                            <p></p>
                        ...
                        <div class="item m-t-15">
                            <a href="" class="image">
                                @if (file_exists(public_path() . '/images/brands/' . $datas->image) && $datas->image != '')
                                    <img class="owl-lazy" title="{{ $datas->name }}" width="200px" height="200px"
                                        data-src="{{ url('images/brands/' . $datas->image) }}"
                                        alt="{{ $datas->name }}">
                                @else
                                    <img class="owl-lazy" title="{{ $datas->name }}" width="200px" height="200px"
                                        data-src="{{ Avatar::create($datas->name)->toBase64() }}"
                                        alt="{{ $datas->name }}">
                                @endif
                            </a>
                        </div>
    ...
    <div>
        ...
        @if (
            ($enable_newsletter_widget->home == '1' && isset($enable_newsletter_widget)) ||
                $enable_newsletter_widget->shop == '1')
                                ...
                                <form method="post" action="{{ url('newsletter') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto"> <button type="submit"
                                                class="text-white btn btn-block newsletter-bg-custom"><i
                                                    class="fa fa-paper-plane-o me-2"></i>Subscribe</button> </div>
                                    </div>
                                </form>
                                    ...
                                    <ul class="toggle-footer">
                                        ...
                                        @if (!empty($genrals_settings->mobile))
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <a href="tel:{{ $genrals_settings->mobile }}"
                                                        tiltle="Mobile No.">{{ $genrals_settings->mobile }}</a>
                                                </div>
                                            </li>
                                        @endif
                                        @if (!empty($genrals_settings->email))
                                            <li class="media">
                                                ...
                                                <div class="media-body"> <span><a
                                                            href="mailto:{{ $genrals_settings->email }}"
                                                            tiltle="E-Mail">{{ $genrals_settings->email }}</a></span>
                                                </div>
                                            </li>
                                        @endif
                                    </ul>
                            ...
                            <ul class='list-unstyled'>
                                @if (Auth::check())
                                    <li class="first"><a href="{{ url('profile') }}"
                                            title="My Account">{{ __('staticwords.MyAccount') }}</a>
                                    </li>
                                    <li><a href="{{ url('order') }}"
                                            title="Order History">{{ __('staticwords.OrderHistory') }}</a></li>
                                @endif
                                <li><a href="{{ url('faq') }}" title="Faq">{{ __('staticwords.faqs') }}</a>
                                </li>
                                ...
                                <ul class='list-unstyled'>
                                    <li class="first">
                                        ...
                                        @if ($foo->link_by == 'page' && isset($foo->gotopage['slug']))
                                            <a title="{{ $foo->title }}"
                                                href="{{ route('page.slug', $foo->gotopage['slug']) }}">
                                                {{ $foo->title }}
                                            </a>
                                        @else
                                            <a target="__blank" title="{{ $foo->title }}"
                                                href="{{ $foo->url }}">
                                                {{ $foo->title }}
                                            </a>
                                        @endif
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-lg-4 no-padding social">
                        <ul class="link">
                            @foreach ($socials as $social)
                                <li class="{{ $social->icon }} pull-left"><a target="_blank" rel="nofollow"
                                        href="{{ $social->url }}"></a>
                                </li>
                            @endforeach
                        </ul>
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-4 no-padding copyright">
                        &copy; {{ date('Y') }} @if (isset($Copyright))
                            {{ $Copyright }}
                        @endif
                    </div>
                        ...
                        <div class="clearfix payment-methods">
                            ...
                            <div class="owl-carousel home-owl-carousel owl-theme  owl-loaded owl-drag">
                                @if ($Api_settings->paypal_enable == '1')
                                    <div class="payment-item">
                                        <a title="Paypal" target="__blank" href="https://paypal.com"><img
                                                data-src="{{ url('images/payment/paypal.png') }}" alt="Paypal"
                                ...
                                @if ($Api_settings->stripe_enable == '1')
                                    <div class="payment-item">
                                        <a title="Stripe" target="__blank" href="https://stripe.com/"><img
                                                data-src="{{ url('images/payment/stripe.png') }}" alt="Razorpay"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->braintree_enable == '1')
                                    <div class="payment-item">
                                        <a title="Braintree" target="__blank"
                                            href="https://www.braintreepayments.com/"><img
                                ...
                                @if ($Api_settings->paystack_enable == '1')
                                    <div class="payment-item">
                                        <a title="Paystack" target="__blank" href="https://paystack.com/"><img
                                                data-src="{{ url('images/payment/paystack.png') }}" alt="Paystack"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->paytm_enable == '1')
                                    <div class="payment-item">
                                        <a title="Paytm" target="__blank" href="https://paytm.com"><img
                                                data-src="{{ url('images/payment/paytm.png') }}" alt="Paytm"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->razorpay == '1')
                                    <div class="payment-item">
                                        <a title="Razorpay" target="__blank" href="https://razorpay.com/"><img
                                                data-src="{{ url('images/payment/razorpay.png') }}" alt="Razorpay"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->payhere_enable == '1')
                                    <div class="payment-item">
                                        <a title="Payhere" target="__blank" href="https://www.payhere.lk/"><img
                                                data-src="{{ url('images/payment/payhere.png') }}" alt="Payhere"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->omise_enable == '1')
                                    <div class="payment-item">
                                        <a title="Omise" target="__blank" href="https://www.omise.co"><img
                                                data-src="{{ url('images/payment/omise.png') }}" alt="omise"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->cashfree_enable == '1')
                                    <div class="payment-item">
                                        <a title="Cashfree" target="__blank" href="https://www.cashfree.com/"><img
                                                data-src="{{ url('images/payment/cashfree.png') }}" alt="cashfree"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->moli_enable == '1')
                                    <div class="payment-item">
                                        <a title="mollie" target="__blank" href="https://www.mollie.com/en"><img
                                                data-src="{{ url('images/payment/mollie.png') }}" alt="mollie"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->rave_enable == '1')
                                    <div class="payment-item">
                                        <a title="Rave" target="__blank"
                                            href="https://dashboard.flutterwave.com/"><img
                                                data-src="{{ url('images/payment/rave.png') }}" alt="rave"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->skrill_enable == '1')
                                    <div class="payment-item">
                                        <a title="Skrill" target="__blank" href="https://www.skrill.com/"><img
                                                data-src="{{ url('images/payment/skrill.png') }}" alt="skrill"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->sslcommerze_enable == '1')
                                    <div class="payment-item">
                                        <a title="SSLCommerz" target="__blank"
                                            href="https://www.sslcommerz.com/"><img
                                                data-src="{{ url('images/payment/sslcommerz.png') }}" alt="skrill"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->enable_amarpay == '1')
                                    <div class="payment-item">
                                        <a title="Aamarpay" target="__blank" href="https://aamarpay.com/"><img
                                                data-src="{{ url('images/payment/aamarpay.png') }}" alt="skrill"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                                ...
                                @if ($Api_settings->iyzico_enable == '1')
                                    <div class="payment-item">
                                        <a title="Iyzico Payment" target="__blank"
                                            href="https://www.iyzico.com/"><img
                                                data-src="{{ url('images/payment/iyzico.png') }}" alt="skrill"
                                                class="owl-lazy img-fluid"></a>
                                    </div>
                                @endif
                ...
                <div class="col-md-6">
                    <div class="no-padding social">
                        ...
                        <div class="d-inline col-12 col-sm-12 col-md-12 col-lg-12 no-padding copyright">
                            <span style="padding-left: 15px;">&copy; {{ date('Y') }} @if (isset($Copyright))
                                    {{ $Copyright }}</span>
                            @endif
                        </div>
                    </div>
    ...
    <script src="{{ url('front/home/js/owl.carousel.min') }}"></script>
...
<script>
    $(document).ready(function () {
        ...
        @if(session('warning'))
            console.log("Warning Session: ", @json(session('warning')));
