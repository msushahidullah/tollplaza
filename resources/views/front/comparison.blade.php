...
@section('title', __('staticwords.YourCompareList') . ' - ' . 'Emart')
@section('body')
                        ...
                        @if (!empty(Session::get('comparison')))
                                                            ...
                                                            @php
                                                                ...
                                                                if ($commision_setting->type == 'flat') {
                                                                    ...
                                                                    if ($commision_setting->p_type == 'f') {
                                                                        $totalprice =
                                                                            $orivar->products->vender_price +
                                                                            $orivar->price +
                                                                            $commission_amount;
                                                                        $totalsaleprice =
                                                                            $orivar->products->vender_offer_price +
                                                                            $orivar->price +
                                                                            $commission_amount;

                                                                        if (
                                                                            $orivar->products->vender_offer_price == 0
                                                                        ) {
                                                ...
                                                @if ($orivar->def == 1)
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            if (Auth::check()) {
                                                                $incart = App\Cart::where('user_id', Auth::user()->id)
                                                                    ->where('variant_id', $orivar->id)
                                                                    ->first();
                                                                if (isset($incart)) {
                                                                    $incartcheck = 1;
                                                                } else {
                                                        ...
                                                        @if ($incartcheck == 1)
                                                            @auth
                                                                <a title="{{ __('staticwords.Removefromcart') }}"
                                                                    href="{{ route('rm.cart', $orivar->id) }}"
                                                                    class="btn-upper btn btn-primary">{{ __('staticwords.Removefromcart') }}</a>
                                                            @else
                                                                <a title="{{ __('staticwords.Removefromcart') }}"
                                                                    href="{{ route('rm.session.cart', $orivar->id) }}"
                                                                    class="btn-upper btn btn-primary">{{ __('staticwords.Removefromcart') }}</a>
                                                            @endif
                                                        @else
                                                            @if ($price_login != 1)
                                                                <form method="POST"
                                                                    ...
                                                                    @csrf
                                                                    <button title="{{ __('Add this variant in cart') }}"
                                                                        type="submit"
                                                    ...
                                                    @php
                                                        ...
                                                        if ($commision_setting->type == 'flat') {
                                                            ...
                                                            if ($commision_setting->p_type == 'f') {
                                                                ...
                                                                $totalprice =
                                                                    ($orivar->products->vender_price + $orivar->price) *
                                                                    $commission_amount;
                                                            ...
                                                            if (isset($comm)) {
                                                                if ($comm->type == 'f') {
                                                                    ...
                                                                    if (
                                                                        $orivar->products->vender_offer_price == 0 ||
                                                                        $orivar->products->vender_offer_price == null
                                                                    ) {
                                                                        $show_price = $price;
                                                                    } else {
                                                                        $convert_price = $offer;
                                        ...
                                        <td>
                                            <div class="product-price">
                                                @if ($price_login == 0 || Auth::check())
                                                    ...
                                                    @endif
                                                @else
                                                    <span class="price"><a title="Login to view price"
                                                            href="{{ route('login') }}">{{ __('Login to view price') }}</a></span>
                                                @endif
                                            </div>
                                        </td>
                                    @endif
                                    ...
                                    @if (isset($product) && $product->status == 1)
                                        <td>
                                            @foreach ($product->subvariants as $orivar)
                                                @if ($orivar->def == 1)
                                                    <p class="in-stock">
                                                        {{ $orivar->stock > 0 ? __('In Stock') : __('Out of Stock') }}</p>
                                                @endif
                                            @endforeach
                                        </td>
                                    @endif
                                            ...
                                            @foreach ($product->subvariants as $orivar)
                                                @if ($orivar->def == 1)
                                                    @if (isset($orivar->unitname['short_code']))
                                                        <p class="in-stock">
                                                            {{ $orivar->weight . $orivar->unitname['short_code'] }}</p>
                                                    @endif
                                                @endif
                                            @endforeach
                                        </td>
                            ...
                            <tr>
                                ...
                                @foreach (Session::get('comparison') as $product)
                                    ...
                                    @endphp
                                    @if (isset($pro) && $pro->status == 1)
                                        <td class='text-center'><a href="{{ route('remove.compare.product', $pro->id) }}"
                                                class="remove-icon"><i class="fa fa-times"></i></a></td>
                                    @endif
                                @endforeach
                            </tr>
                            </table>
