...
@section('title',filter_var($store->name).' | Emart')
@section('body')
                                                ...
                                                @if($price_login == '0' || Auth::check())
                                                    ...
                                                    <div class="product-price">
                                                        @if($product['offerprice'] == 0)
                                                            <span class="price"><i
                                                                class="{{session()->get('currency')['value']}}"></i>{{ sprintf("%.2f",(int)$product['mainprice']*(int)$conversion_rate) }}
                                                            </span>
                                                        @else
                                                            <span class="price"><i
                                                                class="{{session()->get('currency')['value']}}"></i>{{ sprintf("%.2f",(int)$product['offerprice']*(int)$conversion_rate) }}
                                                            </span>
                                                            ...
                                                            <div class="product-price">
                                                                @if($product['offerprice'] == 0)
                                                                    <span class="price"><i
                                                                        ...
                                                                        {{ sprintf("%.2f",(int)$product['mainprice']*(int)$conversion_rate) }}
                                                                    </span>
                                                                @else
                                                                    <span class="price"><i
                                                                        class="{{session()->get('currency')['value']}}"></i>{{ sprintf("%.2f",(int)$product['offerprice']*(int)$conversion_rate) }}
