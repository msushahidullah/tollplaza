                ...
                <div class="col-md-4">
                    <div class="overall-rating-main-block left-sidebar">
                        <div class="overall-rating-block text-center">
                            ...
                            <div class="total-review">{{ $count = count($mainproreviews) }} {{ __('Ratings &') }}
                    ...
                    <div class="row">
                        @if ($type == 'v')
                            <div class="col-lg-1 col-md-2 col-xs-3 viewall-img">
                                <img class="img-fluid" title="{{ $product->name }}"
                                    src="{{ url('variantimages/' . $product->subvariants[0]->variantimages['main_image']) }}"
                                    alt="{{ $product->subvariants[0]->variantimages['main_image'] }}">
                            </div>
                        @else
                            <div class="col-lg-1 col-md-2 col-xs-3 viewall-img">
                                <img class="img-fluid" title="{{ $product->product_name }}"
                        ...
                        <div class="col-lg-11 col-md-6 col-xs-9">
                            <h3><a
                                    href="{{ $type == 'v' ? $product->getURL($product->subvariants[0]) : $product->slug() }}">{{ $type == 'v' ? $product->name : $product->product_name }}</a>
                            </h3>
                            <div class="pull-left">
                                <div class="star-ratings-sprite">
                                    <span style="width:<?php echo $ratings_var; ?>%" class="star-ratings-sprite-rating"></span>
                        ...
                        @if ($review->status == '1')
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-xs-9">
                                    ...
                                    <small class="pull-right allreview-date">{{ __('On') }}
