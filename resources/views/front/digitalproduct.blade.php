...
@section('title', "$product->product_name | Emart")
@section('meta_tags')
...
@section('body')
    <nav class="navbar navbar-dark display-none navbarBlue stickCartNav fixed-top">
        <div class="container-fluid">
            ...
            <div id="navbarSupportedContent">
                ...
                @endif
                <form
                    action="{{ $product->type == 'ex_product' ? $product->external_product_link : route('add.cart.simple', ['pro_id' => $product->id, 'price' => $product->price, 'offerprice' => isset($d_price) ? $d_price : ($product->offer_price != 0 || $product->offer_price != '' ? $product->offer_price : 0)]) }}"
                    method="{{ $product->type == 'ex_product' ? 'GET' : 'POST' }}">
                    @csrf
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item">
                            <div class="quant-input">
                                <input type="number" value="1" name="qty" min="{{ $product->min_order_qty }}"
                                    max="{{ $product->max_order_qty != '' ? $product->max_order_qty : '' }}"
                                    maxorders="null" class="qty-section">
                        ...
                        <li class="nav-item active">
                            <div id="cartForm">
                                <div id="cartForm">
                                    @if ($product->pre_order == 1 && $product->product_avbl_date > date('Y-m-d h:i:s'))
                                        <button type="submit" class="btn btn-cart"><i class="fa fa-shopping-cart"
                                                aria-hidden="true"></i>
                                            {{ $product->type != 'ex_product' ? __('PRE-ORDER NOW') : 'Buy Now' }} <span
                                                class="sr-only">(current)</span></button>
                                    @elseif($product->stock != 0)
                                        <button type="submit" class="btn btn-cart"><i class="fa fa-shopping-cart"
                                                aria-hidden="true"></i>
                                            {{ $product->type != 'ex_product' ? __('staticwords.AddtoCart') : 'Buy Now' }}
                                            <span class="sr-only">(current)</span></button>
                                    @else
                                        <button type="button" class="btn btn btn-cart-oos"><i class="fa fa-shopping-cart"
                                                aria-hidden="true"></i>
                                            {{ $product->type != 'ex_product' ? __('staticwords.Outofstock') : 'Buy Now' }}
                                            <span class="sr-only">(current)</span></button>
                                    @endif
                                </div>
                            </div>
    ...
    <div class="body-content outer-top-xs outer-top-xs-one detail-page-block">
                ...
                <div class='mb-5 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-2 sidebar left-sidebar'>
                    <div class="side-content">
                        <div class="sidebar-module-container">
                            @php
                                $isad = App\DetailAds::where('position', '=', 'prodetail')
                                    ->where('linked_id', $product->id)
                                    ->where('status', '=', '1')
                                    ->first();
                            @endphp
                            @if (isset($isad))
                                <div class="home-banner outer-top-n outer-bottom-xs">
                                    ...
                                    @else
                                        @if ($isad->show_btn == '1')
                                            <h3 class="buy-heading" style="color:{{ $isad->hcolor }}">
                                                {{ $isad->top_heading }}</h3>
                                            <h5 class="buy-sub-heading" style="color:{{ $isad->scolor }}">
                                                {{ $isad->sheading }}</h5>
                                            <center><a
                                                    href="
                   @if ($isad->linkby == 'category') @php
                   ...
                   @elseif($isad->linkby == 'url')
                    {{ $isad->url }} @endif"
                                                    style="color:{{ $isad->btn_txt_color }};background: {{ $isad->btn_bg_color }}"
                                                    class="btn buy-button">{{ $isad->btn_text }}</a></center>
                                            <img src="{{ url('images/detailads/' . $isad->adimage) }}" alt="advertise"
                                                class="img-fluid">
                  ...
                  ">
                                                ...
                                                <h5 class="buy-sub-heading" style="color:{{ $isad->scolor }}">
                                                    {{ $isad->sheading }}</h5>
                                                <img class="img-fluid"
                                                    src="{{ url('images/detailads/' . $isad->adimage) }}"
                                                    alt="advertise">
                                            </a>
                                        @else
                                            <a
                  ...
                  ">
                            ...
                            @if (count($hotdeals) && isset($enable_hotdeal) && $enable_hotdeal->shop == '1')
                                <div
                                    class="mb-2 d-md-none d-sm-none d-lg-block sidebar-widget sidebar-widget-one hot-deals hot-deals-one outer-bottom-xs">
                                                ...
                                                <div class="products">
                                                    ...
                                                    <div class="product-info text-left m-t-20">
                                                        <h3 class="name"><b><a href="{{ $deal['producturl'] }}"
                                                                    title="{{ $deal['productname'][session()->get('changed_language')] ?? $deal['productname'][config('translatable.fallback_locale')] }}">
                                                                    {{ $deal['productname'][session()->get('changed_language')] ?? $deal['productname'][config('translatable.fallback_locale')] }}</a></b>
                                                        </h3>
                                                        @if ($deal['rating'] != '0')
                                                            <div class="">
                                                                <div class="star-ratings-sprite"><span
                                                                        style="width:<?php echo $deal['rating']; ?>%"
                                                                ...
                                                                @if ($price_login == 0 || Auth::check())
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <span class="price-before-discount">
                                                                            <i
                                                                                class="{{ session()->get('currency')['value'] }}"></i>{{ $deal['mainprice'] }}
                                                                        </span>
                                                                    @endif
                                                                @endif
                                                        </div>
                                    ...
                                    <div class="data-sticky">
                                        <div id="single-product-gallery-item">
                                            @isset($product->productGallery)
                                                <center>
                                                    <a class="lightboxmain"
                                                        href="{{ url('images/simple_products/gallery/' . $product->productGallery[0]['image']) }}"
                                                        data-lightbox="image-1" data-title="{{ $product->product_name }}">
                                                        <img alt="miniproductimage"
                                                            src="{{ url('images/simple_products/gallery/' . $product->productGallery[0]['image']) }}"
                                                            class="thumb_pro_img img img-fluid zoom-img drift-demo-trigger"
                                ...
                                <div class="product-info product-x">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="pull-left">
                                                    <div class="stock-box">
                                                        <span class="label">{{ __('staticwords.Availability') }} :
                                                            ...
                                                            @else
                                                                <span
                                                                    class="{{ $product->stock == 0 ? 'text-danger' : 'text-green' }}">
                                                ...
                                                <div class="seller-info">{{ __('staticwords.by') }} <a
                                                        ...
                                                        class="lnk">
                                                        {{ $product->store->name }} @if ($product->store->verified_store)
                                                ...
                                                @if (isset($overallrating) && $overallrating != 0)
                                                    ...
                                                    <div class="pull-left">
                                                        <div class="reviews-rating">
                                                            {{ round($overallrating, 1) }} <i class="fa fa-star"
                                                                aria-hidden="true"></i>
                                                        </div>
                                                    </div>
                                                ...
                                                @else
                                                    ...
                                                    <p></p>
                                                @endif
                                                <p><i class="color147ED2 fa fa-handshake-o" aria-hidden="true"></i> Trust
                                                    of <b>
                                                            ...
                                                            <div class="quantity-container info-container">
                                                                <div>
                                                                    <div class="qty-count">
                                                                        @if ($product->pre_order == 1 && $product->product_avbl_date > date('Y-m-d h:i:s'))
                                                                            @if ($product->preorder_type == 'partial')
                                                                                @php
                                                                                    ...
                                                                                    $d_price =
                                                                                        ($price *
                                                                                            $product->partial_payment_per) /
                                                                                        100;
                                                                                @endphp
                                                                            @endif
                                                                            <form
                                                                                action="{{ route('add.cart.simple', ['pro_id' => $product->id, 'price' => $product->price, 'offerprice' => $d_price ?? $product->offer_price]) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                <div>
                                                                                    ...
                                                                                    <div class="add-btn">
                                                                                        @if ($product->type == 'ex_product')
                                                                                            <a href="{{ $product->external_product_link }}"
                                                                                                role="button"
                                                                        ...
                                                                        @else
                                                                            <form
                                                                                action="{{ route('add.cart.simple', ['pro_id' => $product->id, 'price' => $product->price, 'offerprice' => isset($d_price) ? $d_price : ($product->offer_price != 0 || $product->offer_price != '' ? $product->offer_price : 0)]) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                <div>
                                                                                    <div class="cart-quantity">
                                    ...
                                    <div class="rating-reviews">
                                                ...
                                                <div class="col-sm-6 col-xs-12 col-md-8">
                                                    <div class="price-box price-box-border">
                                                        @if ($product->pre_order == 1 && $product->product_avbl_date > date('Y-m-d h:i:s'))
                                                            ...
                                                            @if ($product->offer_price != 0)
                                                                <span
                                                                    class="margin-top-15 font-size-20 price-strike price-strike-main dtl-price-strike-main">
                                                                    <i
                                                                        class="{{ session()->get('currency')['value'] }}"></i>
                                                                    {{ price_format($product->price * $conversion_rate) }}
                                                                </span>
                                                            @endif
                                                            @if ($product->preorder_type == 'partial')
                                                                @php
                                                                    echo '<p class="text-primary"> (Pay ' .
                                                                        $product->partial_payment_per .
                                                                        '% of product price now and rest amount pay when product is available).</p>';
                                                                    $price =
                                                                        $product->offer_price != 0
                                                                            ? $product->offer_price
                                                                            : $product->price;
                                                                    $d_price =
                                                                        ($price * $product->partial_payment_per) / 100;
                                                                    $d_price = price_format(
                                                                        $d_price * $conversion_rate,
                                                                    );
                                                                    $print_price =
                                                                        '<i class="' .
                                                                        session()->get('currency')['value'] .
                                                                        '"></i>';
                                                        ...
                                                        @else
                                                            ...
                                                            @if ($product->offer_price != 0)
                                                                @php
                                                                    $getdisprice =
                                                                        $product->price * $conversion_rate -
                                                                        $product->offer_price * $conversion_rate;
                                                                    $gotdis =
                                                                        $getdisprice /
                                                                        ($product->price * $conversion_rate);
                                                    ...
                                                    @if (isset($cashback_settings) && $cashback_settings->enable == 1)
                                                        <span
                                                            ...
                                                            {{ __('Buy now and earn cashback in your wallet') }}
                                                            {{ $cashback_settings->discount_type }} @if ($cashback_settings->cashback_type == 'fix')
                                                                <i
                                                                    class="{{ session()->get('currency')['value'] }}"></i><b>{{ sprintf('%.2f', $cashback_settings->discount * $conversion_rate) }}</b>
                                                            @else
                                                                <b>{{ $cashback_settings->discount . '%' }}</b>
                                                            @endif
                                                        </span>
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mt-2 col-sm-6 col-xs-12 col-md-4">
                                                    <div class="favorite-button header-nav-screen">
                                                        <a class="btn btn-primary" data-toggle="modal"
                                                            data-placement="right" title="Share"
                                                       ...
                                                       @if ($product->type != 'ex_product')
                                                            ...
                                                            @if (Auth::check())
                                                                <a class="add_in_wish_simple btn btn-primary {{ inwishlist($product->id) == true ? 'bg-primary text-white' : '' }}"
                                                                    data-proid="{{ $product->id }}"
                                                                    data-status="{{ inwishlist($product->id) }}"
                                                                    data-toggle="tooltip" data-placement="right"
                                                                    title="{{ inwishlist($product->id) == false ? __('staticwords.AddToWishList') : __('staticwords.RemoveFromWishlist') }}"
                                                                    href="javascript:void(0)"
                                                                    id="{{ inwishlist($product->id) == true ? 'removefromwish' . $product->id : 'addtowish' . $product->id }}">
                                                                    <i class="fa fa-heart"></i>
                                                                </a>
                                                            @else
                                                                <a class="btn btn-primary" 
                                                                    data-toggle="tooltip" data-placement="right"
                                                                    title="{{ __('staticwords.LoginToAddWishlist') }}"
                                                                    href="{{ route('login') }}">
                                                                    <i class="fa fa-heart"></i>
                                                                </a>
                                                            @endif
                                                            ...
                                                            @if ($m == 0)
                                                                <a class="btn btn-primary" data-toggle="tooltip"
                                                                    ...
                                                                    href="javascript:void(0)"
                                                                    id="addtocompare{{ $product->id }}"
                                                                    onclick="addToCompare({{ $product->id }}); return false;">
                                                                    <i class="fa fa-signal"></i>
                                                                </a>
                                                            @else
                                                                <a class="abg btn btn-primary" data-toggle="tooltip"
                                                                    data-placement="right"
                                                                    title="Remove From Compare List"
                                                                    href="javascript:void(0)"
                                                                    id="removefromcompare{{ $product->id }}"
                                                                    onclick="removeFromCompare({{ $product->id }}); return false;">
                                                                    <i class="fa fa-signal"></i>
                                                                </a>
                                                            @endif
                                                            @if ($product->catlog != '' && file_exists(public_path() . '/productcatlog/' . $product->catlog))
                                                                <a class="abg btn btn-primary" data-toggle="tooltip"
                                                                    data-placement="right" title="Download catlog"
                                        ...
                                        <div class="dc row">
                                                    ...
                                                    <form id="myForm" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                <input placeholder="{{ __('Enter Pincode') }}" required
                                                                    class="pincode-input form-control"
                                                                    onchange="SubmitFormData()" type="text"
                                                                    id="deliveryPinCode" value="">
                                            ...
                                            <div
                                                class="{{ $pincodesystem == 1 ? 'col-md-5' : 'col-md-8' }} description-container ">
                                                <p></p>
                                                <div class="description-heading">{{ __('staticwords.otherservices') }}
                                                </div>
                                                <div class="price-container info-container">
                                                        ...
                                                        <div class="row">
                                                            @if ($product->cod_avbl == 1)
                                                                <div class="col-lg-3 col-4">
                                                                    <div class="image">
                                                                        <img src="{{ url('/images/icon-cod.png') }}"
                                                                            class="img-fluid" alt="img">
                                                                    </div>
                                                                    <div class="detail text-center">
                                                                        {{ __('staticwords.podtext') }}</div>
                                                                </div>
                                                            @endif
                                                            @if ($product->return_avbl == 1)
                                                                <div class="col-lg-3 col-4">
                                                                    <div data-toggle="modal" data-target="#returnmodal"
                                                                        class="image">
                                                                        <img src="{{ url('/images/icon-returns.png') }}"
                                                                            class="img-fluid" alt="img">
                                                                    </div>
                                                                    <div class="detail">
                                                                        {{ $product->returnPolicy->days }}
                                                                        {{ __('staticwords.returndays') }}
                                                                    </div>
                                                                </div>
                                                                <!-- Modal -->
                                                            ...
                                                            @else
                                                                <div class="col-lg-3 col-4">
                                                                    ...
                                                                    <div class="detail">{{ __('staticwords.noreturn') }}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if ($product->free_shipping == 1)
                                                                <div class="col-lg-4 col-4">
                                                                    <div class="image">
                                                                        <img src="{{ url('/images/icon-delivered.png') }}"
                                                                            class="img-fluid" alt="img">
                                                                    </div>
                                                                    <div class="detail">{{ config('app.name') }}
                                                                        {{ __('staticwords.freedelivery') }}</div>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            @if (isset($product->key_features))
                                                <div class="col-md-6 description-container">
                                                    <div class="description-heading">{{ __('staticwords.Highlight') }}
                                                    </div>
                                                    <div class="description-list">
                                                        {!! $product->key_features !!}
                                                    </div>
                                                    <div class="report-text"><a href="#reportproduct" data-toggle="modal"
                                                            title="">
                                                            <img alt="commenticon"
                                                                src="{{ url('/images/comment.png') }}">{{ __('staticwords.rprotext') }}.</a>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <h6 class="ml-3 float-right">
                                                            <a class="text-primary" data-toggle="modal"
                                                                data-target="#previewModal" role="button">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="fast-delivery-block">
                                        ...
                                        <p>{{ __('staticwords.With') }} {{ config('app.name') }}
                                            {{ __('staticwords.qtext') }}.</p>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="fast-delivery-block">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-12">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                    ...
                                    <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#prodesc"
                                        role="tab" aria-controls="v-pills-home" aria-selected="true"><i
                                            class="fa fa-list"></i>
                                        {{ __('staticwords.Description') }}</a>
                                    <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#prospec"
                                        role="tab" aria-controls="v-pills-profile" aria-selected="false"><i
                                            class="fa fa-bars"></i>
                                        {{ __('staticwords.prospecs') }}</a>
                                    @if ($product->frames()->count())
                                        <a class="nav-link" id="v-tab-pro-360" data-toggle="pill"
                                            href="#v-tab-pro-360-tour" role="tab" aria-controls="v-tab-pro-360-tour"
                                            aria-selected="false"><i class="fa fa-repeat"></i>
                                            {{ __('Product 360째 Tour') }}
                                        </a>
                                    @endif
                                    @if ($product->type != 'ex_product')
                                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill"
                                            href="#v-tab-pro-reviews" role="tab" aria-controls="v-tab-pro-reviews"
                                            aria-selected="false"><i class="fa fa-star"></i>
                                            {{ __('staticwords.reviewratetext') }}</a>
                                    @endif
                                    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill"
                                        href="#v-pro-comments" role="tab" aria-controls="v-pills-settings"
                                        aria-selected="false"><i class="fa fa-comment"></i>
                                        {{ count($product->comments) }} {{ __('staticwords.Comments') }}</a>
                                    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pro-faqs"
                            ...
                            <div class="col-lg-9">
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="prodesc" role="tabpanel"
                                        ...
                                        <p><b>{{ __('Tags') }}:</b>
                                            ...
                                            @endphp
                                            @foreach ($x as $tag)
                                                <span class="badge badge-secondary"><i class="fa fa-tags"></i>
                                                    {{ $tag }}</span>
                                            @endforeach
                                        </p>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="prospec" role="tabpanel"
                                    ...
                                    <!-- 360 Tour Tab -->
                                    @if ($product->frames()->count())
                                        <div class="tab-pane fade" id="v-tab-pro-360-tour" role="tabpanel"
                                            aria-labelledby="v-tab-pro-360-tour">
                                            <h5>{{ __('Move your mouse left or right to rotate the image') }}</h5>
                                            <div style="margin-left: -80px" id="produdct360tour"></div>
                                        </div>
                                    @endif
                                    ...
                                    @if ($product->type != 'ex_product')
                                        <div class="tab-pane fade" id="v-tab-pro-reviews" role="tabpanel"
                                            ...
                                            @auth
                                                @php
                                                    $purchased = App\Order::whereJsonContains(
                                                        'simple_pro_ids',
                                                        $product->id,
                                                    )
                                                        ->where('user_id', Auth::user()->id)
                                                        ->first();
                                                    $alreadyrated = $product->reviews
                                                ...
                                                @if ($purchased)
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                @if ($alreadyrated->users->image != '')
                                                                    <img src="{{ url('/images/user/' . $alreadyrated->users->image) }}"
                                                            ...
                                                            <div class="col-md-8">
                                                                <p>
                                                                    ...
                                                                    <small class="pull-right rating-date">On
                                                                        ...
                                                                        @if ($alreadyrated->status == 1)
                                                                            <span
                                                                                class="badge badge-success font-weight-bold"><i
                                                                                    class="fa fa-check"
                                                                                    aria-hidden="true"></i>
                                                                                {{ __('Approved') }}</span>
                                                                        @else
                                                                ...
                                                                <div class="pull-left">
                                                                    <div class="star-ratings-sprite"><span
                                                                            style="width:<?php echo $ratings_var1; ?>%"
                                                                            class="star-ratings-sprite-rating"></span></div>
                                                                </div>
                                                                <br>
                                                                <span
                                                                    class="font-weight500">{{ $alreadyrated->review }}</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <a title="{{ __('View all reviews') }}"
                                                            class="font-weight-bold pull-right"
                                                                ...
                                                                <div class="overall-rating-main-block">
                                                                    <div class="overall-rating-block text-center">
                                                                        ...
                                                                        <div class="overall-rating-title">
                                                                            {{ __('staticwords.OverallRating') }}</div>
                                                                        <div class="rating">
                                                                            @php
                                                                                $review_t = 0;
                                                                                $price_t = 0;
                                                                            ...
                                                                            @if (!empty($reviews2[0]))
                                                                                ...
                                                                                @endphp
                                                                                <div class="star-ratings-sprite"><span
                                                                                        style="width:<?php echo $ratings_var2; ?>%"
                                                                                        class="star-ratings-sprite-rating"></span>
                                                                                </div>
                                                                            @else
                                                                                <div class="text-center">
                                                                        ...
                                                                        <div class="total-review">
                                                                            {{ $count = count($product->reviews->where('status', '1')) }}
                                                                            {{ __('Ratings &') }} {{ $reviewcount }}
                                                                            {{ __('reviews') }}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    @if ($overallrating > 3.9)
                                                                        <div
                                                                            class="overall-rating-block satisfied-customer-block text-center">
                                                                            <h3>100%</h3>
                                                                            <div class="overall-rating-title">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-2">
                                                                                @if ($review->users->image != '')
                                                                                    <img src="{{ url('/images/user/' . $review->users->image) }}"
                                                                                        alt=""
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                ...
                                                                                <small
                                                                                    class="pull-right rating-date">{{ __('On') }}
                                                                                    {{ date('jS M Y', strtotime($review->created_at)) }}</small>
                                                                                <br>
                                                                                <span
                                                                                    class="font-weight500">{{ $review->review }}</span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                        <hr>
                                                    ...
                                                    @else
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                                <div class="overall-rating-main-block">
                                                                    <div class="overall-rating-block text-center">
                                                                        ...
                                                                        <div class="total-review">
                                                                            {{ $count = count($product->reviews) }} Ratings &
                                                            ...
                                                            <div class="col-md-8 product-add-review">
                                                                ...
                                                                <div class="review-form">
                                                                    <form class="cnt-form" method="post"
                                                                        action="{{ route('user.review', $pro->id) }}">
                                                                        @csrf
                                                                        @if ($errors->any())
                                                                        ...
                                                                        <div class="form-container">
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea class="form-control text-rev" name="review" id="exampleInputReview" rows="5" cols="50"
                                                                            ...
                                                                            <div class="action text-right">
                                                                                <button type="submit"
                                                                                    class="btn btn-primary btn-upper">{{ __('staticwords.SUBMITREVIEW') }}</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                        ...
                                                        @if ($product->reviews()->where('status', '1')->count())
                                                            ...
                                                            @endforeach
                                                        @else
                                                            <h5><i class="fa fa-star"></i> {{ __('staticwords.ratetext') }}
                                                            </h5>
                                                        @endif
                                                    @endif
                                                @else
                                                ...
                                                @endif
                                            @else
                                                <h5>{{ __('staticwords.Please') }} <a
                                                        href="{{ route('login') }}">{{ __('staticwords.Login') }}</a>
                                                            ...
                                                            <div class="overall-rating-main-block">
                                                                <div class="overall-rating-block text-center">
                                                                    ...
                                                                    <div class="rating">
                                                                        ...
                                                                        @else
                                                                            <div class="text-center">{{ __('No Rating') }}
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                    <div class="total-review">
                                                                ...
                                                                @if ($overallrating > 3.9)
                                                                    <div
                                                                        ...
                                                                        <h3>100%</h3>
                                                                        <div class="overall-rating-title">
                                                                            {{ __('staticwords.SatisfiedCustomer') }}</div>
                                                                        <p>{{ __('staticwords.customerText') }}</p>
                                                                    </div>
                                                                @endif
                                                            </div>
                                    ...
                                    <!-- Comments Tab -->
                                    <div class="tab-pane fade" id="v-pro-comments" role="tabpanel"
                                        aria-labelledby="v-pro-comments-tab">
                                        ...
                                        @forelse($product->comments->sortByDesc('id')->take(5) as $key=> $comment)
                                            <div class="mt-2 media border border-default p-2">
                                                <img src="{{ Avatar::create($comment->name)->toGravatar() }}"
                                                    class="align-self-center mr-3" alt="{{ $comment->name }}">
                                                <div class="media-body">
                                                    <small
                                                        class="float-right">{{ $comment->created_at->diffForHumans() }}</small>
                                                    <h5 class="mt-0">{{ $comment->name }}</h5>
                                                    <p class="mb-0">{!! $comment->comment !!}</p>
                                                </div>
                                            </div>
                                            <div class="appendComment"></div>
                                        @empty
                                            <h4><i class="fa fa-trophy"></i> {{ __('staticwords.NoCommentProduct') }}
                                            </h4>
                                        @endforelse
                                        @if (count($product->comments) > 5)
                                            <p></p>
                                            <div class="remove-row">
                                                <button data-simpleproduct="yes" data-proid="{{ $product->id }}"
                                                    data-id="{{ $comment->id }}"
                                        ...
                                        <form action="{{ route('post.comment') }}" method="POST" novalidate
                                            ...
                                            @csrf
                                            <div class="form-group">
                                                <label>{{ __('staticwords.Name') }}: <span
                                                        class="text-red">*</span></label>
                                                <input value="{{ old('name') }}" required autofocus name="name"
                                                    type="text" class="form-control">
                                                <span class="text-red">{{ $errors->first('name') }}</span>
                                            </div>
                                            <div class="form-group">
                                                <label>{{ __('staticwords.eaddress') }}: <span
                                                        class="text-red">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label>{{ __('staticwords.Comment') }}: <span
                                                        class="text-red">*</span></label>
                                                <textarea name="comment" required placeholder="{{ __('staticwords.Comment') }}" class="form-control"
                                                    rows="3" cols="30">{{ old('comment') }}</textarea>
                                                <span class="text-red">{{ $errors->first('comment') }}</span>
                                            </div>
                                            <button type="submit"
                                                class="btn btn-primary">{{ __('staticwords.Submit') }}</button>
                                        </form>
                                    </div>

                                    <!-- FAQs Tab -->
                                    <div class="tab-pane fade" id="v-pro-faqs" role="tabpanel"
                                        aria-labelledby="v-pro-comments-tab">
                                                            ...
                                                            @if ($orivar->def == '1')
                                                                @php
                                                                    ...
                                                                    for ($i = 0; $i < $var_name_count; $i++) {
                                                                        ...
                                                                        $var_name[$i] =
                                                                            $orivar['main_attr_value'][$var_id];
                                                                        $name[$i] = App\ProductAttributes::where(
                                                                            'id',
                                                                            $var_id,
                                                                        )->first();
                                                                    }
                                                                    ...
                                                                    <div class="products">
                                                                        <div class="product">
                                                                            <div class="product-image">
                                                                                <div
                                                                                    class="image {{ $orivar->stock == 0 ? 'pro-img-box' : '' }}">
                                                                                    <a href="{{ $url }}"
                                                                                        ...
                                                                                        @else
                                                                                            <img class="owl-lazy {{ $orivar->stock == 0 ? 'filterdimage' : '' }}"
                                                                                                title="{{ $relproduct->name }}"
                                                                                                data-src="{{ url('/images/no-image.png') }}"
                                                                                                alt="No Image" />
                                                                                        @endif
                                                                                    </a>
                                                                                </div>
                                                                                @if ($orivar->stock == 0)
                                                                                    <h5 align="center" class="oottext">Out
                                                                                        of stock</h5>
                                                                                @endif
                                                                                @if (
                                                                                    $orivar->stock != 0 &&
                                                                                        $orivar->products->selling_start_at != null &&
                                                                                    ...
                                                                                    <ul class="list-unstyled">
                                                                                        ...
                                                                                        @auth
                                                                                            ...
                                                                                            @else
                                                                                                ...
                                                                                                @else
                                                                                                    <li class="lnk wishlist">
                                                                                                        <a title="{{ __('Add to wish list') }}"
                                                                                                            mainid="{{ $orivar->id }}"
                                                                                                            class="add-to-cart addtowish text-white cursor-pointer"
                                                                                                            data-add="{{ url('AddToWishList/' . $orivar->id) }}"
                                                                                                            title="Wishlist">
                                                                                                            <i
                                                                                                                class="activeOne icon fa fa-heart"></i>
                                                                                        ...
                                                                                        <li class="lnk"> <a
                                                                                                class="add-to-cart"
                                                                                                href="{{ route('compare.product', $relpro->id) }}"
                                                                                                title="{{ __('Compare') }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                        <h5 class="modal-title p-2" id="myModalLabel">{{ __('staticwords.ReportProduct') }}
                            {{ $product->name }}</h5>
                    </div>
                    <div class="modal-body">
        ...
        <!-- Modal -->
        <div class="modal fade" id="notifyMe" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-sm modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/subscribe/for/product/stock/' . $product->id) }}" method="POST"
                            class="notifyForm">
                            @csrf
    ...
    @section('script')
       ...
       <script>
// Enhanced wishlist functionality for simple products
$(document).on('click', '.add_in_wish_simple', function(e) {
    e.preventDefault();
    
    var proid = $(this).data('proid');
    var isInWishlist = $(this).hasClass('bg-primary');
    
    console.log("[SIMPLE WISHLIST] Product ID:", proid, "Currently in wishlist:", isInWishlist);
    
    if (isInWishlist) {
        // Remove from wishlist
        removeFromSimpleWishlist(proid, $(this));
    } else {
        // Add to wishlist
        addToSimpleWishlist(proid, $(this));
    }
});

function addToSimpleWishlist(proid, element) {
    var addToWishUrl = '{{ route('add.simple.pro.in.wishlist', ':id') }}'.replace(':id', proid);
    ...
    $.ajax({
        ...
        method: 'GET',
        success: function(response) {
            console.log("[ADD SIMPLE WISHLIST] Response:", response);
            
            if (response.status === 'success') {
                Swal.fire({
                    title: "Added",
                    text: response.msg || 'Product added to your wishlist!',
                    icon: 'success'
                });
                
                // Update button appearance and functionality
                element.addClass('bg-primary text-dark')
                       .attr('title', '{{ __('staticwords.RemoveFromWishlist') }}')
                       .attr('id', 'removefromwish' + proid);
                ...
                Swal.fire({
                    title: "Already Added",
                    text: response.msg || 'Product is already in your wishlist!',
                    icon: 'info'
                });
        ...
        error: function(xhr, status, error) {
            console.error("[ADD SIMPLE WISHLIST] AJAX Error:", {
...
function removeFromSimpleWishlist(proid, element) {
    var removeFromWishUrl = '{{ url('/removesimplesWishList/:id') }}'.replace(':id', proid);
    ...
    $.ajax({
        ...
        method: 'GET',
        success: function(response) {
            console.log("[REMOVE SIMPLE WISHLIST] Response:", response);
            
            if (response.status === 'deleted' || response === 'deleted') {
                Swal.fire({
                    title: "Removed",
                    text: response.msg || 'Product removed from your wishlist!',
                    icon: 'success'
                });
                
                // Update button appearance and functionality
                element.removeClass('bg-primary text-dark')
                       .attr('title', '{{ __('staticwords.AddToWishList') }}')
                       .attr('id', 'addtowish' + proid);
        ...
        error: function(xhr, status, error) {
            console.error("[REMOVE SIMPLE WISHLIST] AJAX Error:", {
                response: xhr.responseText,
                status,
                error
            });
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.status === 'success') {
                ...
                Swal.fire({
                    title: "Added",
                    text: response.message || 'Product added to comparison!',
                    icon: 'success'
                });
                
                // Update UI to show remove button
                $('#addtocompare' + id).attr('onclick', 'removeFromCompare(' + id + '); return false;')
                                       .attr('title', 'Remove From Compare List')
                                       .attr('id', 'removefromcompare' + id);
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.status === 'success') {
                ...
                Swal.fire({
                    title: "Removed",
                    text: response.message || 'Product removed from comparison!',
                    icon: 'success'
                });
                
                // Update UI to show add button
                $('#removefromcompare' + id).attr('onclick', 'addToCompare(' + id + '); return false;')
                                            .attr('title', 'Add to Compare')
                                            .attr('id', 'addtocompare' + id);
