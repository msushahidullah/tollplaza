...
@section('meta_tags')
    ...
    <meta property="og:image"
        content="{{ url('variantimages/thumbnails/' . $pro->subvariants[0]->variantimages->main_image) }}" />
                        ...
                        <div class="favorite-button header-nav-smallscreen">
                            <span class="favorite-button-one">
                                <a class="btn btn-primary" data-toggle="tooltip" data-placement="right"
                                    title="{{ __('Add to Compare') }}" href="{{ route('compare.product', $pro->id) }}">
                ...
                <div class='mb-5 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-2 sidebar left-sidebar'>
                  ...
                  ">
                                                ...
                                                <h5 class="buy-sub-heading" style="color:{{ $isad->scolor }}">
                                                    {{ $isad->sheading }}</h5>
                                                <img class="img-fluid"
                                                    src="{{ url('images/detailads/' . $isad->adimage) }}" alt="advertise">
                                            </a>
                                        @else
                                            <a
                                                href="
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                    ...
                                                    <div class="margin-left25">
                                                        <div class="reviews">
                                                            <a href="{{ route('allreviews', ['id' => $pro->id, 'type' => 'v']) }}"
                                                                class="lnk">&nbsp;&nbsp;{{ $count = count($pro->reviews) }}
                                                                {{ __('ratings and') }}
                                                ...
                                                @if ($pro->w_d != 'None' && $pro->w_my != 'None' && $pro->w_type != 'None')
                                                    <p> <i class="color147ED2 fa fa-refresh" aria-hidden="true"></i>
                                                        {{ $pro->w_d }}
                                                        {{ ucfirst($pro->w_my) }} {{ __('staticwords.of') }}
                                                        {{ $pro->w_type }}</p>
                                                @endif
                                                <p><i class="color147ED2 fa fa-handshake-o" aria-hidden="true"></i> Trust
                                                    ...
                                                    @if ($image = @file_get_contents('images/brands/' . $pro->brand->image))
                                                        <img alt="brandlogo" class="pro-brand"
                                                            src="{{ url('/images/brands/' . $pro->brand->image) }}">
                                                    @else
                                                        <img alt="brandlogo" class="pro-brand"
                                    ...
                                    <div class="rating-reviews">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12 col-md-8">
                                                    ...
                                                    @if (isset($cashback_settings) && $cashback_settings->enable == 1)
                                                        <span
                                                            ...
                                                            {{ $cashback_settings->discount_type }} @if ($cashback_settings->cashback_type == 'fix') <i
                                                ...
                                                <div class="col-sm-6 col-xs-12 col-md-4">
                                                    <div class="favorite-button header-nav-screen">
                                                        ...
                                                        @else
                                                            <a class="abg bg-primary btn btn-primary removeFrmWish"
                                                                data-toggle="tooltip" data-placement="right"
                                                                title="Remove From Compare List"
                                                                href="{{ route('remove.compare.product', $pro->id) }}">
                                                                <i class="fa fa-signal"></i>
                                                            </a>
                                                        @endif
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            @if ($pro->return_avbl == 1)
                                                                <div class="col-lg-3 col-4">
                                                                    ...
                                                                    <div class="detail">{{ $pro->returnPolicy->days }}
                                                                    ...
                                                                    <tr>
                                                                        <td width="20%">
                                                                            @if (strpos($cvar->attribute->attr_name, $attrkey) == false)
                                                                                <span
                                                                                    class="font-size-14 font-weight-bold">{{ $cvar->attribute->attr_name }}</span>
                                                                            @else
                                                                                <span
                                                                        ...
                                                                        <td width="20%">
                                                                            @if (
                                                                                $cvar->attribute->attr_name == 'Color' ||
                                                                                    $cvar->attribute->attr_name == 'color' ||
                                                                                    $cvar->attribute->attr_name == 'Colour' ||
                                                                                    $cvar->attribute->attr_name == 'colour')
                                                                        ...
                                                                        <tr>
                                                                            <td width="33%">
                                                                                @php
                                                                                    $getattrname = App\ProductAttributes::where(
                                                                                        'id',
                                                                                        '=',
                                                                                        $mainvariant->attr_name,
                                                                                    )->first();
                                                                                @endphp
                                                                                <span id="Size"
                                                                                    class="font-weight-bold">
                                                                                    <label class="atrbName"
                                                                                        indexnum="{{ $indexNum }}"
                                                                                        id="{{ $getattrname->id }}"
                                                                            ...
                                                                            <td>
                                                                                @foreach ($mainvariant->attr_value as $subvalue)
                                                                                    @php
                                                                                        $getvaluename = App\ProductValues::where(
                                                                                            'id',
                                                                                            '=',
                                                                                            $subvalue,
                                                                                        )->first();
                                                                                    ...
                                                                                    @foreach ($pro->subvariants as $key => $ss)
                                                                                        @if (isset($ss->main_attr_value[$getattrname->id]) && $ss->main_attr_value[$getattrname->id] == $getvaluename->id)
                                                                                            @if ($getvaluename->proattr->attr_name == 'Color')
                                                                                                <a role="button"
                                                                                                    class="mt-2 mainvar font-weight-bold xyz"
                                                                                                    @if (isset($getvaluename) && strcasecmp($getvaluename->values, $getvaluename->unit_value) != 0) title="{{ $getvaluename->values }}"
                                        @else
                                        title="{{ $getvaluename->values ?? '' }}" @endif
                                                                                                    attr_id="{{ $getattrname->id }}"
                                                                                                    @if (isset($getvaluename) && strcasecmp($getvaluename->values, $getvaluename->unit_value) != 0) @if ($getvaluename->proattr->attr_name == 'Color')
                                        ...
                                        '{{ $indexNum }}')"
                                                                                                    ...
                                                                                                    @if (env('SHOW_IMAGE_INSTEAD_COLOR') === true)
                                                                                                        <img class="object-fit img-thumbnail"
                                                                                                            width="50px"
                                                                                                            src="{{ url('/variantimages/' . $ss->variantimages->image1) }}"
                                                                                                            alt="{{ $ss->variantimages->image1 }}">
                                                                                                    @else
                                                                                                        <i style="color:{{ $getvaluename->unit_value }}"
                                                                                            ...
                                                                                            @else
                                                                                                <a class="mainvar font-weight-bold xyz"
                                                                                                    data-toggle="tooltip"
                                                                                                    data-placement="top"
                                                                                                    @if (isset($getvaluename) && strcasecmp($getvaluename->values, $getvaluename->unit_value) != 0) title="{{ $getvaluename->values }} {{ $getvaluename->unit_value }}" @else
                                        title="{{ $getvaluename->values }}" @endif
                                                                                                    attr_id="{{ $getattrname->id }}"
                                                                                                    @if (isset($getvaluename) && strcasecmp($getvaluename->values, $getvaluename->unit_value) != 0) @if ($getvaluename->proattr->attr_name == 'Color')
                                          ...
                                          valname="{{ $getvaluename->values }}{{ $getvaluename->unit_value }}" @endif
                                                                                                @else
                                                                                                    ...
                                                                                                    onclick="tagfilter('{{ $getattrname->attr_name }}','{{ $getvaluename->id }}',
                                        '{{ $indexNum }}')">
                                                                                                    @if (isset($getvaluename) &&
                                                                                                            strcasecmp($getvaluename->values, $getvaluename->unit_value) != 0 &&
                                                                                                            $getvaluename->unit_value != null)
                                                                                                        {{ $getvaluename->values }}
                                                                                                        {{ $getvaluename->unit_value }}
                                                                                                    @else
                                                                                                        {{ $getvaluename->values ?? '' }}
                                                                                                    @endif
                                                                                                </a>
                                            ...
                                            @if ($findproinorder == 1)
                                                            ...
                                                            <p>
                                                                ...
                                                                <small class="pull-right rating-date">On
                                                                    ...
                                                                    @if ($alreadyrated->status == 1)
                                                                        <span class="badge badge-success font-weight-bold"><i
                                                ...
                                                @else
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9 product-add-review">
                                                        ...
                                                        <div class="overall-rating-main-block">
                                                            <div class="overall-rating-block text-center">
                                                                ...
                                                                <div class="rating">
                                                                    ...
                                                                    @else
                                                                        <div class="text-center">{{ __('No Rating') }}</div>
                                                                    @endif
                                                                </div>
                                                                <div class="total-review">
                                                                    {{ $count = count($pro->reviews) }}
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                        <h5 class="modal-title p-3" id="myModalLabel">{{ __('staticwords.ReportProduct') }}
                            {{ $pro->name }}</h5>
                    </div>
                    <div class="modal-body">
