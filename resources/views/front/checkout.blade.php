...
if(!empty($pri)) {
    ...
    break; // or continue, depending on context
                       ...
                       <div class="row">
                        ...
                        <div class="text-right col-12 offset-md-3 col-md-9 offset-xl-0 col-xl-3">
                          ...
                          @endphp
                          <!-- <b>+ {{ price_format($row->shipping*$conversion_rate) }}</b>  -->
                          <!-- <i
                            class="{{ session()->get('currency')['value'] }}"></i> <small class="text-muted"><b>(
                              {{__('staticwords.Shipping')}} )</b></small> -->
                         <p></p>
                ...
                <div class="col-md-12 col-12 final_step-btn">
                  ...
                  @if($genrals_settings->min_pur_amount != 0 && $genrals_settings->min_pur_amount != ' ')
                      ...
                      <div id="off_button">
                      <button disabled id="final_step"
                          class="pull-right btn btn-primary">{{__('staticwords.ProccedtoPayment')}}</button>
                          <strong style="color: red;">The minimum purhcase amount is <i class="fa {{ Session::get('currency')['value'] }}"></i> {{ $genrals_settings->min_pur_amount }} 
                        </strong>
                      </div>
                  @else
                  <button id="final_step"
              ...
              <div class="row">
                <div class="col-4 col-md-3">
                  ...
                  <div class="nav flex-column nav-pills" aria-orientation="vertical">
                    ...
                    <a class="nav-link active" href="#paypalpaytab" id="paypal" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      Paypal </a>
                    @endif
                    @if($wallet_system == '1')
                    <a class="nav-link" href="#walletpay" id="walletpay" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      {{ __('staticwords.Wallet') }}</a>
                    @endif
                    @if($config->braintree_enable == '1')
                    <a class="nav-link" href="#braintreePay" id="braintree" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      Braintree</a>
                    @endif
                    @if($config->paystack_enable == '1')
                    <a class="nav-link" href="#paystackpay" id="paystack" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      Paystack</a>
                    @endif
                    @if($config->instamojo_enable == '1')
                    <a class="nav-link" href="#instapaytab" id="instamojo" onclick=handlingcharge(this.id) onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      Instamojo</a>
                    @endif
                    @if($config->stripe_enable == '1')
                    <a class="nav-link" href="#cardpaytab" id="stripe" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}Card</a>
                    @endif
                    @if($config->payu_enable == '1')
                    <a class="nav-link" href="#payupaytab" id="payupay" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }} PayUBiz/
                      Money</a>
                    @endif
                    @if($config->paytm_enable == '1')
                    <a class="nav-link" href="#paytmtab" id="paytm" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }} Paytm</a>
                    @endif
                    @if($config->razorpay == '1')
                    <a class="nav-link" href="#razorpaytab" id="razorpay" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      RazorPay</a>
                    @endif
                    @if($config->payhere_enable == '1')
                    <a class="nav-link" href="#payheretab" id="payhere" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }} Payhere</a>
                    @endif
                    @if($config->cashfree_enable == '1')
                    <a class="nav-link" href="#cashfreeTab" id="cashfree" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      Cashfree</a>
                    @endif
                    @if($config->omise_enable == '1')
                    <a class="nav-link" href="#omiseTab" id="omise" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }} Omise</a>
                    @endif
                    @if($config->rave_enable == '1')
                    <a class="nav-link" href="#raveTab" id="rave" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }} Rave</a>
                    @endif
                    @if($config->moli_enable == '1')
                    <a class="nav-link" href="#mollieTab" id="moli" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }} Mollie</a>
                    @endif
                    @if($config->skrill_enable == '1')
                    <a class="nav-link" href="#skrillTab" id="skrill" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }} Skrill</a>
                    @endif
                    @if($config->sslcommerze_enable == '1')
                    <a class="nav-link" href="#sslcommerz" id="sslcommerz" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      SSlCommerz</a>
                    @endif
                    @if($config->enable_amarpay == '1')
                    <a class="nav-link" href="#aamarpay" id="aamarpay" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      AAMARPAY</a>
                    @endif
                    @if($config->iyzico_enable == '1')
                    <a class="nav-link" href="#iyzico_payment_tab" id="iyzico" onclick=handlingcharge(this.id) data-toggle="tab">{{ __('staticwords.PayVia') }}
                      Iyzcio</a>
                    @endif
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="paypalpaytab">
                      ...
                      <form action="{{ route('processTopayment') }}" method="POST">
                        ...
                        <button type="submit" class="paypal-buy-now-button">
                          <span>{{ __('Express Checkout with ddd') }}</span>
                    ...
                    <div class="tab-pane show active" id="paypalpaytab">
                      ...
                      <form action="{{ route('processTopayment') }}" method="POST">
                        ...
                        <input type="hidden" name="actualtotal" value="{{ $un_sec }}">
                        <button type="submit" class="paypal-buy-now-button">
                          <span>{{ __('Express Checkout withjjjjj') }}</span>
                          <svg aria-label="PayPal" xmlns="http://www.w3.org/2000/svg" width="90" height="33"
                            viewBox="34.417 0 90 33">
                            <path fill="#253B80"
                              d="M46.211 6.749h-6.839a.95.95 0 0 0-.939.802l-2.766 17.537a.57.57 0 0 0 .564.658h3.265a.95.95 0 0 0 .939-.803l.746-4.73a.95.95 0 0 1 .938-.803h2.165c4.505 0 7.105-2.18 7.784-6.5.306-1.89.013-3.375-.872-4.415-.972-1.142-2.696-1.746-4.985-1.746zM47 13.154c-.374 2.454-2.249 2.454-4.062 2.454h-1.032l.724-4.583a.57.57 0 0 1 .563-.481h.473c1.235 0 2.4 0 3.002.704.359.42.469 1.044.332 1.906zM66.654 13.075h-3.275a.57.57 0 0 0-.563.481l-.146.916-.229-.332c-.709-1.029-2.29-1.373-3.868-1.373-3.619 0-6.71 2.741-7.312 6.586-.313 1.918.132 3.752 1.22 5.03.998 1.177 2.426 1.666 4.125 1.666 2.916 0 4.533-1.875 4.533-1.875l-.146.91a.57.57 0 0 0 .562.66h2.95a.95.95 0 0 0 .939-.804l1.77-11.208a.566.566 0 0 0-.56-.657zm-4.565 6.374c-.316 1.871-1.801 3.127-3.695 3.127-.951 0-1.711-.305-2.199-.883-.484-.574-.668-1.392-.514-2.301.295-1.855 1.805-3.152 3.67-3.152.93 0 1.686.309 2.184.892.499.589.697 1.411.554 2.317zM84.096 13.075h-3.291a.955.955 0 0 0-.787.417l-4.539 6.686-1.924-6.425a.953.953 0 0 0-.912-.678H69.41a.57.57 0 0 0-.541.754l3.625 10.638-3.408 4.811a.57.57 0 0 0 .465.9h3.287a.949.949 0 0 0 .781-.408l10.946-15.8a.57.57 0 0 0-.469-.895z">
                    ...
                    <div class="tab-pane show" id="paystackpay">
                      ...
                      <hr>
                        @if(pre_order_disable() == false)
                          ...
                          <input type="hidden" name="orderID" value="{{ uniqid() }}">
                          <input type="hidden" class="total_paystack_amount" name="amount"
                          ...
                          <div class="braintree">
                            <form method="POST" id="bt-form" action="{{ route('pay.bt') }}">
                              ...
                              <button class="payment-final-bt d-none btn btn-md btn-primary" type="submit">
                                Pay  sdds<i class="{{ session()->get('currency')['value'] }}"></i>
                                <span class="payment_amount_label">
                                    {{ price_format(Crypt::decrypt($secure_amount)) }}
                                </span> Now
                              </button>
                    ...
                    <div class="tab-pane show" id="braintreePay">
                      ...
                      @if(pre_order_disable() == false)
                       <a href="javascript:void(0);" class="payment-btn bt-btn btn btn-md btn-primary"><i
                        class="fa fa-credit-card"></i> Pay via Card / Paypal kkk</a>
                        <div class="braintree">
                          <form method="POST" id="bt-form" action="{{ route('pay.bt') }}">
                            {{ csrf_field() }}
                            <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-container active">
                                <form method="POST" action="{{ route('paytostripe') }}" id="stripe-form" >
                                  @csrf
                                  <input type="hidden" name="actualtotal" value="{{ $un_sec }}">
                    ...
                    <div class="tab-pane" id="payheretab">
                      ...
                      @if(pre_order_disable() == false)
                        <form method="post" action="https://sandbox.payhere.lk/pay/checkout">
                          ...
                          <input type="hidden" name="currency" value="{{ session('currency')['id'] ?? 'LKR' }}">
                          <input type="hidden" name="amount" class="total_secure_amount" value="{{ $secure_amount }}">
                          ...
                          <button type="submit" class="payhere-buy-now-button">
                            <span> <i class="{{ session('currency')['value'] ?? '' }}"></i>
                              {{ sprintf("%.2f",Crypt::decrypt($secure_amount),2) }} <img
                                src="{{ url('images/payherel.png') }}" alt="payherelogo" title="Pay with Payhere"></span>
                          </button>
                        </form>
                        <hr>
                        <p class="text-muted"><i class="fa fa-lock"></i>
    ...
    @php
        ...
        // Start COD flow logging
        \Log::info('COD Flow Started', [
            'order_id'   => $order,
            'cart_count' => count($cart_table),
        ]);
    @endphp
    @foreach($cart_table as $cod_chk)
        @php
            if(isset($cod_chk->product)){
                ...
                \Log::info('COD Check (product)', [
                    'product_id'   => $cod_chk->product->id ?? null,
                    'product_name' => $cod_chk->product->name ?? null,
                    'codcheck'     => $cod_chk->product->codcheck,
                ]);
            }
            if(isset($cod_chk->simple_product)){
                array_push($codcheck, $cod_chk->simple_product->cod_avbl);
                \Log::info('COD Check (simple_product)', [
                    'simple_product_id'   => $cod_chk->simple_product->id ?? null,
                    'simple_product_name' => $cod_chk->simple_product->product_name ?? null,
                    'cod_avbl'            => $cod_chk->simple_product->cod_avbl,
                ]);
            }
        @endphp
    @endforeach
    @php
        \Log::info('COD Summary', [
            'codcheck_array'        => $codcheck,
            'checkout_currency'     => $checkoutsetting_check->checkout_currency ?? null,
            'secure_amount'         => $secure_amount ?? null,
            'decrypted_amount'      => isset($secure_amount) ? Crypt::decrypt($secure_amount) : null,
            'currency_id'           => session()->get('currency')['id'] ?? null,
        ]);
    @endphp
    @if($checkoutsetting_check->checkout_currency == 1)
        <div class="tab-pane" id="codpaytab">
            @if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'cashOnDelivery'))
                ...
                @else
                    @php $token = str_random(25); @endphp
                    <h3>{{__('staticwords.Pay')}} 
                        <i class="{{ session()->get('currency')['value'] }}"></i>
                        <span class="payment_amount_label">
                            {{ price_format(Crypt::decrypt($secure_amount)) }}
                        </span>
                ...
                <tr>
                  <th>
                    ...
                    <div class="cart-sub-total">
                      <div class="row">
                        <div class="text-left col-md-4 col-xs-4">{{ __('Gift Discount') }}</div>
                    ...
                    <div class="cart-sub-total">
                      <div class="row">
                        ...
                        <div class="col-lg-8 col-8">
                          ...
                          @if($shippingChage)
                          <span id="new_shpping"> <i class="{{session()->get('currency')['value']}}"></i> {{$shippingChage}} </span>
                          @else
                            Free
                          @endif
                          </span>
                    ...
                    <div class="cart-sub-total totals-value " id="cart-total">
                      <div class="row">
                        ...
                        <div class="col-md-8 col-5">
                          <input type="hidden" id="hiddenhandingcharge" value="{{  price_format($handlingcharge) }}">
                          <span class="" id="show-total">
                            <i
                              class="{{session()->get('currency')['value']}}"></i>
                              <span class="payment_handling_label">
                              {{  price_format($handlingcharge) }}
                              </span>*
                          </span>
                        </div>
                      </div>
...
<script>
  ...
  function freeshippingcode(){
    ...
    if(getfreeshippingcode == freeshipping){
      $('#new_shpping').text(0);
