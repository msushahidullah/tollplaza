                    ...
                    <ul class="list-unstyled">
                        ...
                        @auth
                            ...
                            @if($simple_pro->type != 'ex_product')
                                ...
                                <li class="lnk wishlist {{ inwishlist($simple_pro->id) ? 'active' : '' }}">
                                    @if(inwishlist($simple_pro->id))
                                        <a id="removefromwish{{ $simple_pro->id }}"
                                            onclick="removeFromWishlist({{ $simple_pro->id }}, 'simple', {{ $simple_pro->id }}); return false;"
                                            class="cursor-pointer removeFrmWish icon kal addtocartcus btn text-dark"
                                            title="{{ __('staticwords.RemoveFromWishlist') }}">
                                            <i class="fa fa-heart"></i>
                                        </a>
                                    @else
                                        <a id="addtowish{{ $simple_pro->id }}"
                                            onclick="addToWishlist({{ $simple_pro->id }}, 'simple', {{ $simple_pro->id }}); return false;"
