<form id="demo-form2" method="post" action="{{route('category.store')}}" data-parsley-validate
  ...
  {{ csrf_field() }}
  <br>
  <label for="exampleInputSlug">{{ __('Category') }}:<sup class="color-red">*</sup></label>
  <input type="text" placeholder="{{ __('Enter Your category') }}" class="form-control" name="category" id="exampleInputPassword1"
    value="" colmd>

  <br>
  <label for="exampleInputSlug">{{__('Icon')}}:<sup class="color-red">*</sup></label>
  <input type="text" class="form-control" name="icon" placeholder="{{ __('Enter Your Short icon') }}" id="exampleInputPassword1"
    value="">

  <br>
  <label for="Image">{{ __('Choose image') }}:<sup class="color-red">*</sup></label>
  <input type="file" name="image" class="form-control">
  <br>

  <br>
  <label for="exampleInputSlug">{{ __('Featured') }}:<sup class="color-red">*</sup></label>
  ...
  <br>
  <label for="exampleInputDetails">{{ __('Status') }}:<sup class="color-red">*</sup></label>
