                        ...
                        <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select data-placeholder="{{ __('Please select childcategory') }}" 
                                                name="child_id" 
                                                id="grand" 
                                                class="form-control select2">
                                            <option value="">{{ __('Please choose') }}</option>
                                            @if ($product->subcategory && $product->subcategory->childcategory)
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input min="0" type="text" placeholder="Weight" class="form-control"
                                        name="weight" step="0.01" value="{{ $product->weight }}">
                                </div>
                            </div>
