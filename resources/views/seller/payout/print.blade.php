...
<head>
    ...
    <title>{{__('Payout for Order Item :itemid',['itemid' => $inv_cus->prefix.$payout->singleorder->inv_no.$inv_cus->postfix])}}</title>
            ...
            <div class="contentbar">
                <div class="row ml-0 mb-2">
                    <div class="col-md-12 ml-5">
                        <a href="{{ route('vender.payout.show.complete',$payout->id) }}" class="d-print-none btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>{{ __("Back")}}</a>
                    </div>
                                                    ...
                                                    <table class="table table-borderless text-right">
                                                        <tbody>
                                                            ...
                                                            @if($payout->paidvia =='Paypal')
                                                                ...
                                                                <td><i class="{{ $defCurrency->currency_symbol }}"></i> {{ $payout->txn_fee }} <i title="{{ __('Already paid by admin not included in this total') }}" class="fa fa-info-circle d-print-none"></i></td>
                                                                </tr>
                                                            @else
                                                                <tr>
                                                                <td>{{__('Transcation Charge')}}:</td>
