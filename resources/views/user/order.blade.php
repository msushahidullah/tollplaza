...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-xl-9 my-order-one main-content">
      ...
      <div class="bg-white2">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div align="center">
              <a class="cursor-pointer font-weight700" title="{{ __('View') }} {{ $morecount }} {{ __('more order') }}"
            ...
            <div align="center">
              <a class="display-none font-weight700" title="{{ __('Show Less') }}"
