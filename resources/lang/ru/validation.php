...
return array (
  ...
  'gt' => 
  array (
    'array' => 'У х1 должно быть более х2 предметов.',
    'file' => ' :attribute должно быть больше :value килобайт.',
    'numeric' => 'Х1 должен быть больше х2.',
    'string' => ' :attribute должен быть больше, чем :value символов.',
  ),
  'gte' => 
  array (
    'array' => 'У х1 должно быть х2 предметов или больше.',
  ...
  'lt' => 
  array (
    'array' => 'У х1 должно быть меньше х2 предметов.',
    'file' => 'Размер :attribute должен быть меньше :value килобайт.',
    'numeric' => 'Х1 должен быть меньше х2.',
    'string' => 'Значение :attribute должно быть меньше :value символов.',
  ),
  'lte' => 
  array (
    'array' => 'На :attribute должно быть не более :value предметов.',
    'file' => ' :attribute должен быть меньше или равен :value килобайту.',
  ...
  'min' => 
  array (
    'array' => 'У х1 должно быть не менее х2 предметов.',
    'file' => 'Размер х1 должен быть не менее х2 килобайт.',
