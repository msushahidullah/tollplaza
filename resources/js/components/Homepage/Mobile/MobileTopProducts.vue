<template>
    <div class="row no-pad">
        ...
        <div v-for="cat in products" :v-key="Math.random().toString(36).substring(7)" class="col-12">
            <h3 class="section-title mt-1">
                {{cat.category_name[lang]  ? cat.category_name[lang] : cat.category_name[fallbacklang]}}
            </h3>
            <div class="row">
                <div v-for="product in cat.products" :key="Math.random().toString(36).substring(7)" class="col-6">
                                ...
                                <div class="product-image">
                                    <div :class="{'pro-img-box' : product.stock == 0 }" class="image">
                                        ...
                                        <a :href="product.producturl"
                                            ...
                                            <span v-else>
                                                <img :class="{'filterdimage' : product.stock == 0 }"                                                     :title="product.productname[lang]  ? product.productname[lang] : product.productname[fallbacklang]"
                 ...
                 <div v-for="product in cat.simple_products" :key="product.productid" class="col-6">
                    <div class="item item-carousel">
