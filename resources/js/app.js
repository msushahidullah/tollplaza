...
Vue.component('slider2', require('./components/Homepage/Slider2.vue').default);

Vue.component('slider3', require('./components/Homepage/Slider3.vue').default);
...
// Vue.component('best-sellers', require('./components/Homepage/BestSellers.vue').default);

// Vue.component('best-sellers-slider', require('./components/Homepage/BestSellerSlider.vue').default);
