...
Route::group(['middleware' => ['web','switch_lang']], function () {
    ...
    Route::get('/bestseller', 'Web\HomeController@bestseller');
    ...
    Route::get('vue/get/slider2','Web\HomeController@slider2');
    
    Route::get('vue/get/slider3','Web\HomeController@slider3');
