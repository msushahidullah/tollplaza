...
Route::group(['middleware' => ['web','switch_lang']], function () {
    ...
    Route::group(['middleware' => ['maintainence_mode']], function () {
            ...
            Route::group(['middleware' => ['IsInstalled', 'is_verified', 'isActive', 'two_fa','switch_lang']], function () {
                ...
                Route::get('/tabbed-products/{type}', 'Web\HomeController@getProducts')->name('tabbed.products');
                ...
                Route::post('adminsetting/update','DashboardController@adminsetting')->name('adminsetting.update');
                ...
                Route::get('/cart/sidebar/refresh', 'CartController@refreshCartSidebar')->name('cart.sidebar.refresh');
                ...
                Route::post('user_review/{id}', 'MainController@user_review')->name('user.review');
                ...
                Route::post('apply/gift', 'MainController@apply_gift')->name('apply.gift');
                ...
                Route::get('/get-session-messages', 'MainController@getSessionMessages')->name('get.session.messages');
                ...
                Route::get('/click-tabbed-products/{type}','Web\HomeController@getProducts')->name('tabbed.click.products');

                Route::get('/get/category/url','Web\HomeController@getCategoryUrl');
                Route::get('/get/subcategory/url','Web\HomeController@getSubCategoryUrl');
                Route::get('/get/childcategory/url','Web\HomeController@getChildCategoryUrl');
            });
            ...
            Route::get('/backlogin/as/{id}', 'GuestController@backAdminLogin')->name('backlogin.as');
            ...
            Route::group(['middleware' => ['auth','is_verified','two_fa','switch_lang']], function () {
                ...
                Route::get('AddToWishList/{id}', 'MainController@AddToWishList')->name('add.pro.wishlist');


                Route::get('add/simple_pro/{id}', 'SimpleProductsController@wishlist')->name('add.simple.pro.in.wishlist');
                ...
                Route::get('removesimplesWishList/{id}', 'MainController@removesimplesWishList');
                ...
                Route::post('handlingcharge', 'MainController@handlingcharge')->name('apply.handlingcharge');
                ...
                Route::get('/chatwithadmin/{userid}','ChatController@createadminchat')->name('adminchat.start');
                Route::get('/adminchat/view/{conversation}','ChatController@adminchatscreen')->name('adminchat.screen');
                Route::get('/adminchats/{conv_id}','ChatController@adminchatview')->name('admin.chat.view');
                ...
                Route::group(['middleware' => ['SellerAdminMix']], function () {
                    ...
                    Route::post('/admin/quickupdate/service/{id}', 'QuickUpdateController@serviceUpdate')->name('service.quick.update');
                    ...
                    Route::get('mobile/hotdeal', 'MobileHotDealController@index');
                    Route::post('mobile/hotdeal/store', 'MobileHotDealController@store');
