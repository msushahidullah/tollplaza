...
$(document).ready(function() {
    ...
    $("#notification-open").on("click", function(e) {
        e.preventDefault();
        $(".infobar-settings-sidebar-overlay").css({"background": "rgba(0,0,0,0.4)", "position": "fixed"});
        $("#notification-sidebar").addClass("sidebarshow");
    }); 

    $("#notification-sidebar-close").on("click", function(e) {
        e.preventDefault();
        $(".infobar-settings-sidebar-overlay").css({"background": "transparent", "position": "initial"});
        $("#notification-sidebar").removeClass("sidebarshow");
    });
    ...
    $('.js-switch-setting-first').each(function(){
        new Switchery(this, { color: '#3d9bfb', size: 'small' });
    });
