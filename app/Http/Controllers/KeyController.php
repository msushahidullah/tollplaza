...
class KeyController extends Controller
{
    ...
    public function sslcommerzeUpdate(Request $request){
        ...
        return back()->with('added',__('SSLCommerze settings has been updated !'));
    ...
    public function iyzicoUpdate(Request $request){
        ...
        $this->config->save();
        return back()->with('added',__('Iyzico Payment settings has been updated !'));
    ...
    public function saveBraintree(Request $request)
    {
        ...
        // Create an instance of DotenvEditor
        $dotenvEditor = app('dotenv-editor');
    ...
    public function savePaypal(Request $request)
    {
        ...
        return back()->with('updated', __('Paypal settings have been updated!'));
    }
    ...
    public function payhereUpdate(Request $request){
        ...
        $dotenvEditor->setKeys([
            ...
            'PAYHERE_MODE' => isset($input['PAYHERE_MODE']) ? 'live' : 'sandbox',
 ...
 $dotenvEditor = app('dotenv-editor');
    ...
    public function updateCashfree(Request $request){
        ...
        $this->config->save();
        return back()->with('updated', __('Cashfree payment settings has been updated !'));
    ...
    public function updateSkrill(Request $request){
        ...
        $this->config->save();
        return back()->with('updated', __('Skrill payment settings has been updated !'));
    ...
    public function updateOmise(Request $request){
        ...
        $this->config->save();
        return back()->with('updated', __('Omise payment settings has been updated !'));
    ...
    public function updateMoli(Request $request){
        ...
        return back()->with('updated', __('Mollie payment settings has been updated !'));
    ...
    public function updateRave(Request $request){
        ...
        return back()->with('updated', __('Rave payment settings has been updated !'));
