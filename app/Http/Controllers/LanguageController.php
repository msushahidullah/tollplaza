...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->name))
        {
            ...
            session()->flash('success', __('Language added !'));
        ...
        else
        {
            ...
            return back()->withErrors(__('Oops ! Something went wrong !'));
        }
       
        session()->flash('success', __('Language has been added !'));
    ...
    public function update(Request $request, $id)
    {
        ...
        session()->flash('success', __('Language dtails updated !'));
        ...
        else
        {
            ...
            return back()->withErrors(__('Language not found !'));
        }
    ...
    public function delete($id)
    {
        ...
        if (isset($lang))
        {
            ...
            if ($lang->def == 1)
            {
                ...
                session()->flash('warning', __('Default language cannot be deleted !'));
            ...
            {
                $lang->delete();
                session()->flash('info', __('Language Deleted !'));
    ...
    public function sync_vue_translation(){
        ...
        session()->flash(__('Translation synchronize successfully !'),__('Synced'));
