...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(session()->get('currency')['id'] !='BDT'){
           return redirect(route('order.review'))->withErrors(__("Sorry ONLY :currency currency supported !",['currency' => 'BDT (Takka)']));
        }
        ...
        if (round($request->actualtotal, 2) != $total) {
            ...
            return redirect(route('order.review'))->withErrors(__('Payment has been modifed !'),__('Please try again !'));
        ...
        if (round(Crypt::decrypt($request->amount), 2) < 10) {
            ...
            return redirect(route('order.review'))->withErrors(__('Amount is less than 10 not allowed'));
        }
    ...
    public function success(Request $request)
    {
        ...
        if ($validation == true) {
            ...
            return redirect(route('order.review'))->withErrors(__('Payment Failed !'));
        }
    ...
    public function cancel(Request $request)
    {
        ...
        return redirect(route('order.review'))->withErrors(__('Payment canceled !',$tran_id));
