...
class ManualPaymentGatewayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('success', __('Payment method added !'), $request->payment_name);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$method) {
            ...
            return back()->withErrors(__('Payment method not found !'), 404);
        }
        ...
        session()->flash('success', __('Payment method updated !'), $request->payment_name);
    ...
    public function delete($id)
    {
        ...
        session()->flash('success', __('Payment method deleted !'), $method->payment_name);
    ...
    public function checkout(Request $request, $token)
    {
        ...
        if ($request->actualtotal != $total) {
            ...
            session()->flash('error', __('Payment has been modifed !'), __('Please try again !'));
