...
class StoreController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validateuser->store) {
            ...
            session()->flash('error', __('User already have a store !') );
        ...
        session()->flash('success', __('Store created !'), $store->name);
        return back();
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!$store) {
             session()->flash('error', __('Store Not found !'),'404');
            return back();
        }
        ...
        session()->flash('success', __('Store has been updated !'), $store->name);
    ...
    public function destroy($id)
    {
        ...
        if ($store) {
            ...
            session()->flash('success', __('Store has been updated !'));

            return back();
             
        } else {
         
            session()->flash('success', __('Store Not found !'), '404');
