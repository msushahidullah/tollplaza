...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('success', __('User added!'), $request->name);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($request->is_pass_change) && isset($request->password)) {
        ...
        session()->flash('success', __('details has been updated'), $user->name);
    ...
    public function destroy($id)
    {
        ...
        if ($value) {
            ...
            session()->flash('deleted', __('User has been deleted !'));
            return back();
        }
    }
