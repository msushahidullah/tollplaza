...
class SellerAddvariantController extends Controller
{
    ...
    public function post(Request $request, $id)
    {
        ...
        foreach ($array2 as $key => $value) {
            ...
            if ($conversion_rate == null) {
                ...
                session()->flash("warning",__("Variant already exist ! Kindly Update that"));
        ...
        if (isset($request->def)) {
            ...
            if ($all_def->count() < 1) {
                ...
                session()->flash("warning",__("Atleast one variant should be set to default !"));
                return back();
        ...
        $varimage->save();       
        session()->flash("success",__("Variant Linked Successfully !"));
    ...
    public function delete($id)
    {
        ...
        if ($vars->def != 1) {
            ...
            return back()->withErrors(__('Default variant cannot be deleted !'));

        }

    
        session()->flash("success",__("Variant has been Deleted !"));
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$vars) {
            ...
            return back()->withErrors(__('Product variant not found !'));
        }
        ...
        if ($all_def2->count() < 1) {
            ...
            session()->flash("warning",__("Atleast one value should be set to default !"));
        ...
        if ($newstock < 0) {
            ...
            return back()->withErrors(__('Stock cannot be less than 0 !'));
        }
        ...
        foreach ($array2 as $key => $value) {
            ...
            if ($result == null) {
                ...
                if ($id == $value->id) {
                    ...
                    session()->flash("success",__("Variant has been Updated !"));

                    return redirect()->route('seller.add.var', $vars->pro_id);
                } else {

                    session()->flash("success",__("Linked Variant already exist !"));
                ...
                foreach ($result as $e => $new) {
                    ...
                    if ($new == 0) {
                        ...
                        if ($id == $value->id) {
                            ...
                            session()->flash("success",__("Linked Variant Updated !"));
                            ...
                            session()->flash("warning",__("Linked Variant exist !"));
        ...
        session()->flash("success", __("Variant Updated !"));
