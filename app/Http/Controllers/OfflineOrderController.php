...
class OfflineOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            session()->flash('added', __('Order created successfully !'), $order->order_id);
    ...
    public function show(Request $request,$id)
    {
        ...
        if(!$order || $request->order_id){
            ...
            return redirect(route('offline-orders.index'))->withErrors('Order not found !');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if (isset($request->product_name)) {
                ...
                session()->flash('added', __('Order updated successfully !'), $order->order_id);

                return redirect(route('offline-orders.index'));
            }else{
               
                return redirect(route('offline-orders.index'))->withErrors(__('Order not found !'))->withInput();
            }
    ...
    public function destroy($id)
    {
        ...
        session()->flash('success', __('Order has been deleted !'));
