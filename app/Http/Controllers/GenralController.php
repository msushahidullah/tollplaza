...
class GenralController extends Controller
{
    ...
    public function verifiedupdate($input, $request)
    {
        ...
        $input['min_pur_amount'] = $request->min_pur_amount;
        $input['mim_seller_wid_amount'] = $request->mim_seller_wid_amount;

        $cat->update($input);

      
        session()->flash('success', 'Genral Setting Has Been Updated !');
