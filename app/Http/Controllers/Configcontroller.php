...
class Configcontroller extends Controller
{
    ...
    public function facebookSettings(Request $request)
    {
        ...
        $this->config->save();
        return back()->with('update',__('Facebook Login Settings Updated !'));
    ...
    public function googleSettings($request)
    {
        ...
        $this->config->save();
        session()->flash('success', 'Google login settings updated !');
    ...
    public function twitterSettings($request)
    {
        ...
        $this->config->save();
        session()->flash('success', 'Twitter login settings updated !');
        return back();
    ...
    public function amazonSettings($request)
    {
        ...
        session()->flash('success', 'Amazon login settings updated !');
    ...
    public function linkedinSettings($request)
    {
        ...
        return back()->with('success',__('Linkedin login settings updated !'));
    ...
    public function gitlabSettings($request)
    {
        ...
        $env_keys_save->save();
        return back()->with('added',__('Gitlab settings has been saved'));
