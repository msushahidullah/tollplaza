...
class ChatController extends Controller
{
    ...
    public function createadminchat($userid){
        ...
        return redirect(route('user.chat.view',$conversation->conv_id));
    }
    ...
    public function adminchatscreen($id){
        ...
        return view('user.viewchat',compact('conversation','reciever'));
    ...
    public function userchat(){
        ...
        return view('user.mychat',compact('conversion_rate','conversations','users'));
    }
    ...
    public function adminchatview($id){
