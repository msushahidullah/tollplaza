...
class AddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($alladdress as $value) {
            if ($value->name == $request->name && $value->address == $request->address && $value->city_id == $request->city_id && $value->state_id == $request->state_id && $value->country_id == $request->country_id && $request->pin_code == $value->pin_code) {
                ...
                return redirect('/checkout')->with('error','Same address already stored !');
    ...
    public function store2(Request $request)
    {
        ...
        session()->flash('added', 'Address added successfully !');
    ...
    public function store3(Request $request)
    {
        ...
        session()->flash('error', 'Same address already stored !');
    ...
    public function update(Request $request, $id)
    {
        ...
        session()->flash('update', 'Address updated successfully !');
    ...
    public function delete(Request $request, $id)
    {
        ...
        if ($findaddress->defaddress == 1) {
            ...
            session()->flash('error', 'Default address cannot be deleted !');
