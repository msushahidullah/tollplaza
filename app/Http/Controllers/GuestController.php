...
class GuestController extends Controller
{
    ...
    public function adminLoginAs($id)
    {
        ...
        // echo "asenuipfudfgklsejhtisrdhtiopdzhtpozehg"; die;
    ...
    //   die;
        ...
        if (isset($user)) {
            if($user->role_id=='a'){
                ...
                session()->flash('success', __('Logged in as ' . Auth::user()->name));
                ...
                Session::put('admin_id', $adminlogin);
                return redirect('/');
            }             
        } else {
    ...
    public function backAdminLogin($id)
    {
        // $adminlogin = Auth::user()->id;
    ...
    public function dosellerlogin(Request $request)
    {
        if (Auth::attempt(['email' => $request->get('email'), 'password' => $request->get('password'),
            ...
            if (auth()->user()->getRoleNames() && auth()->user()->getRoleNames()->contains('Seller')) {
                ...
                session()->flash('success', __('Welcome :user',['user' => Auth::user()->name]));
    ...
    public function storereferfromcheckoutwindow(Request $request)
    {
        ...
        session()->flash('success', __('Create address to continue !'));
    ...
    public function showpage($slug)
    {
        ...
        if ($page) {
            ...
            return redirect('/')->with('error','Requested page not found !');
        }
