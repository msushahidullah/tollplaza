...
class TrashController extends Controller
{
    ...
    public function forceDeleteVariantProduct($id){
        ...
        session()->flash('success', __("Product has been permanently deleted !"),__('Success'));
    ...
    public function restorevariantProducts($id){
        ...
        $products->restore();
     session()->flash('success', __("Product has been restored successfully !"),__('Success'));
        return back();
    ...
    public function restoresimpleProducts($id){
        ...
        $product->restore();
        session()->flash('success', __('Product has been restored'),__('Success'));
        return back();
    ...
    public function forceDeleteSimpleProduct($id){
        ...
        $product->forceDelete();
        session()->flash('success', __('Product has been permanently deleted !'),'Success');
        return back();
