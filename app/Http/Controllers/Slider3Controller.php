...
class Slider3Controller extends Controller
{
    ...
    {
        $sliders3 = Slider3::with(['childcategory','category','subcategory','products'])->get();
        return view("admin.slider3.index", compact("sliders3"));
    }
    ...
    public function create()
    {
        ...
        return view("admin.slider3.create", compact("product", "category"));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($file = $request->file('image')) {
            ...
            $optimizePath = public_path() . '/images/slider3/';
        ...
        return redirect()->route('slider3.index')->with('added', __('Slider has been created !'));
    }
    ...
    public function edit($id)
    {
        ...
        $product = Product::all();
        return view("admin.slider3.edit", compact("slider", "product", "category"));
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($file = $request->file('image')) {
            ...
            if (file_exists(public_path() . '/images/slider3/' . $slider->image)) {
                unlink('images/slider3/' . $slider->image);
            }
        ...
        return redirect()->route('slider3.index')->with('added', __('Slider has been updated !'));
