...
class MultiCurrencyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('success', __("Currency :code added !",['code' => $request->code]));
    ...
    public function update(Request $request, $code)
    {
        ...
        if ($currency) {
            ...
            session()->flash('Updated', __("Currency :code updated !",['code' => $currency->code]));
    ...
    public function destroy($id)
    {
        ...
        session()->flash('error', __('Currency deleted successfully !'));
