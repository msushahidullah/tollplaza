...
class OtaUpdateController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        session()->flash('success', __('Updated to version :version successfully',['version' => config('app.version')]),__('Version :version',['version' => config('app.version')]));
    ...
    public function mergeQuickupdate(Request $request)
    {
        ...
        if(!$file){
            ...
            return back()->withErrors(__('Update file not found !'),'404')->withInput();
        }
        ...
        if ($zipped) {
            ...
            if ($extract) {
                ...
                session()->flash('success', __('Quick hot fix update has been merged successfully !'));
