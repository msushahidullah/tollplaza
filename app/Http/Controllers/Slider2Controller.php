...
class Slider2Controller extends Controller
{
    ...
    {
        $sliders = Slider2::with(['childcategory','category','subcategory','products'])->get();
    ...
    public function create()
    {
        ...
        return view("admin.slider2.create", compact("product", "category"));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($file = $request->file('image')) {
            ...
            $optimizePath = public_path() . '/images/slider2/';
        ...
        return redirect()->route('slider2.index')->with('added', __('Slider has been created !'));
    }
    ...
    public function edit($id)
    {
        ...
        $product = Product::all();
        return view("admin.slider2.edit", compact("slider", "product", "category"));
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($file = $request->file('image')) {
            ...
            if (file_exists(public_path() . '/images/slider2/' . $slider->image)) {
                unlink('images/slider2/' . $slider->image);
            }
        ...
        return redirect()->route('slider2.index')->with('added', __('Slider has been updated !'));
