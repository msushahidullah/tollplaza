...
class PushNotificationsController extends Controller
{
    ...
    public function push(Request $request)
    {
        ...
        if(env('ONESIGNAL_APP_ID') =='' && env('ONESIGNAL_REST_API_KEY') == ''){
            ...
            return back()->withErrors(__('Please update onesignal keys in settings !'),__('Keys not found !'));
        }
        ...
        try {
            ...
            return back()->with('success', __('Notification pushed successfully !'));
    ...
    public function updateKeys(Request $request){
        ...
        return back()->with('added',__('Keys updated successfully !'),'OneSignal');
        // return back();
    }
}
