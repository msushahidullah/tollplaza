    ...
    public function cancelOrder(Request $request, $id)
    {
        ...
        if ($order->user_id == Auth::user()->id || Auth::user()->role_id == 'a') {
                ...
                if ($request->source == 'bank') {
                    ...
                    if ($order->payment_method == 'Wallet') {
                        ...
                        if ($this->wallet_system != 1) {
                            ...
                            session()->flash('info', 'Wallet System is deactive currently ! please contact site master regrading this issue !');
                        ...
                        if (isset($order->user->wallet) && $order->user->wallet->status == 1) {
                            ...
                            session()->flash('warning',"Refund can't be proccesed as your wallet is deactive or not found !");
                        ...
                        return back()->with('error','PayU Instant Refund will add soon !');
                        ...
                        if ($refund->isSuccessful()) {
                            ...
                            if ($response['STATUS'] == 'TXN_FAILURE') {
                              ...
                              return back()->with('error', $response['RESPMSG']);
                        ...
                        session()->flash('info', 'For Selected Payment Method Instant Refund is not available !');
            ...
            if ($status == 1) {
                ...
                session()->flash('success', 'Following Order is Cancelled Successfully !');
